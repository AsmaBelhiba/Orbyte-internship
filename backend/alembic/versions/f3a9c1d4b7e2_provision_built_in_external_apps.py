"""Provision Orbyte-managed built-in external apps for existing tenants (cloud only)
...
``orbyte/external_apps/providers/*``.
...
# Frozen snapshot of the Orbyte-managed built-in app catalog. Every managed app
