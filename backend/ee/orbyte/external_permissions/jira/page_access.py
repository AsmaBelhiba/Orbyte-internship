...
from ee.orbyte.external_permissions.jira.models import Holder
from ee.orbyte.external_permissions.jira.models import Permission
from ee.orbyte.external_permissions.jira.models import User
...
def _build_external_access_from_holder_map(
    ...
    if unsupported_holder_counts:
        logger.warning(
            ...
            "static Orbyte ACLs; unsupported_holder_counts=%s all_holder_counts=%s",
            jira_project,
            BROWSE_PROJECTS_PERMISSION,
...
def get_project_permissions(
    ...
    if add_prefix and external_access and external_access.external_user_group_ids:
        prefixed_groups = {
            build_ext_group_name_for_orbyte(g, DocumentSource.JIRA)
