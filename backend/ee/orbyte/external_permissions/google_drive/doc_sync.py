...
from ee.orbyte.external_permissions.google_drive.permission_retrieval import (
...
from orbyte.access.models import NodeExternalAccess
...
def get_external_access_for_raw_gdrive_file(
    ...
    # they will not be granted access in Orbyte.
    ...
    for permission in permissions_list:
        ...
        # we will then handle mapping that folder to the list of Orbyte users
    ...
    if add_prefix:
        group_ids = {
            build_ext_group_name_for_orbyte(group_id, DocumentSource.GOOGLE_DRIVE)
