...
from ee.orbyte.external_permissions.slack.channel_access import get_channel_access
...
from orbyte.connectors.slack.connector import filter_channels
from orbyte.connectors.slack.connector import get_channels
from orbyte.connectors.slack.connector import get_channels_across_teams
from orbyte.connectors.slack.connector import list_grid_team_ids
from orbyte.connectors.slack.connector import make_paginated_slack_api_call
...
def slack_doc_sync(
    ...
    provider = OrbyteDBCredentialsProvider(tenant_id, "slack", cc_pair.credential.id)
