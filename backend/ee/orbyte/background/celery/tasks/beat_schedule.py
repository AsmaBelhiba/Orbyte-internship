...
from ee.orbyte.configs.app_configs import CHECK_TTL_MANAGEMENT_TASK_FREQUENCY_IN_HOURS
...
from orbyte.background.celery.tasks.beat_schedule import generate_cloud_tasks
from orbyte.background.celery.tasks.beat_schedule import (
...
ee_beat_task_templates: list[dict] = [
    {
        ...
        "task": OrbyteCeleryTask.GENERATE_USAGE_REPORT_TASK,
    ...
    },
    {
        ...
        "task": OrbyteCeleryTask.CHECK_TTL_MANAGEMENT_TASK,
    ...
    },
    {
        ...
        "task": OrbyteCeleryTask.EXPORT_QUERY_HISTORY_CLEANUP_TASK,
    ...
    ee_tasks_to_schedule = [
        {
            ...
            "task": OrbyteCeleryTask.HOOK_EXECUTION_LOG_CLEANUP_TASK,
        ...
        },
        {
            ...
            "task": OrbyteCeleryTask.CHECK_LICENSE_EXPIRY_NOTIFICATIONS,
            "schedule": timedelta(days=1),
            "options": {
                "priority": OrbyteCeleryPriority.MEDIUM,
                "expires": BEAT_EXPIRES_DEFAULT,
