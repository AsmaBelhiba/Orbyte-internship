...
from ee.orbyte.background.celery.tasks.external_group_syncing.group_sync_utils import (
    mark_all_relevant_cc_pairs_as_external_group_synced,
)
from ee.orbyte.db.connector_credential_pair import get_all_auto_sync_cc_pairs
from ee.orbyte.db.connector_credential_pair import get_cc_pairs_by_source
from ee.orbyte.db.external_perm import ExternalUserGroup
from ee.orbyte.db.external_perm import mark_old_external_groups_as_stale
from ee.orbyte.db.external_perm import remove_stale_external_groups
from ee.orbyte.db.external_perm import upsert_external_groups
from ee.orbyte.external_permissions.sync_params import (
    get_all_cc_pair_agnostic_group_sync_sources,
)
from ee.orbyte.external_permissions.sync_params import get_source_perm_sync_config
...
from orbyte.configs.constants import CELERY_EXTERNAL_GROUP_SYNC_LOCK_TIMEOUT
...
from orbyte.redis.redis_connector_ext_group_sync import RedisConnectorExternalGroupSync
from orbyte.redis.redis_connector_ext_group_sync import (
...
from orbyte.server.metrics.perm_sync_metrics import inc_group_sync_errors
from orbyte.server.metrics.perm_sync_metrics import inc_group_sync_groups_processed
from orbyte.server.metrics.perm_sync_metrics import inc_group_sync_users_processed
from orbyte.server.metrics.perm_sync_metrics import observe_group_sync_duration
from orbyte.server.metrics.perm_sync_metrics import observe_group_sync_upsert_duration
...
@shared_task(
    name=OrbyteCeleryTask.CHECK_FOR_EXTERNAL_GROUP_SYNC,
    ignore_result=True,
...
def check_for_external_group_sync(self: Task, *, tenant_id: str) -> bool | None:
    ...
    lock_beat: RedisLock = r.lock(
        OrbyteRedisLocks.CHECK_CONNECTOR_EXTERNAL_GROUP_SYNC_BEAT_LOCK,
    ...
    try:
        ...
        lock_beat.reacquire()
        if not r.exists(OrbyteRedisSignals.BLOCK_VALIDATE_EXTERNAL_GROUP_SYNC_FENCES):
            ...
            r.set(
                OrbyteRedisSignals.BLOCK_VALIDATE_EXTERNAL_GROUP_SYNC_FENCES,
                1,
...
def try_creating_external_group_sync_task(
    ...
    try:
        ...
        result = app.send_task(
            OrbyteCeleryTask.CONNECTOR_EXTERNAL_GROUP_SYNC_GENERATOR_TASK,
            kwargs=dict(
                cc_pair_id=cc_pair_id,
                tenant_id=tenant_id,
            ),
            queue=OrbyteCeleryQueues.CONNECTOR_EXTERNAL_GROUP_SYNC,
...
@shared_task(
    name=OrbyteCeleryTask.CONNECTOR_EXTERNAL_GROUP_SYNC_GENERATOR_TASK,
    acks_late=False,
    soft_time_limit=JOB_TIMEOUT,
    track_started=True,
    trail=False,
...
def connector_external_group_sync_generator_task(
    ...
    lock: RedisLock = r.lock(
        OrbyteRedisLocks.CONNECTOR_EXTERNAL_GROUP_SYNC_LOCK_PREFIX
