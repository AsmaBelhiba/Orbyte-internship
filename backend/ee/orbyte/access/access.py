...
from ee.orbyte.db.external_perm import fetch_external_groups_for_user
from ee.orbyte.db.external_perm import fetch_public_external_group_ids
from ee.orbyte.db.user_group import fetch_user_groups_for_documents
...
from orbyte.access.access import (
    _get_access_for_documents as get_access_for_documents_without_groups,
)
from orbyte.access.access import _get_acl_for_user as get_acl_for_user_without_groups
from orbyte.access.access import collect_user_file_access
from orbyte.access.models import DocumentAccess
from orbyte.access.utils import prefix_external_group
from orbyte.access.utils import prefix_user_group
from orbyte.db.document import get_document_sources
...
def _get_access_for_documents(
    ...
    for document_id, non_ee_access in non_ee_access_dict.items():
        ...
        # then it's given the same access level as if it were marked public within Orbyte
...
def get_access_for_user_files_impl(
    ...
    NOTE: is imported in orbyte.access.access by `fetch_versioned_implementation`
    DO NOT REMOVE."""
