...
from ee.orbyte.configs.app_configs import HUBSPOT_TRACKING_URL
from ee.orbyte.server.tenants.access import generate_data_plane_token
from ee.orbyte.server.tenants.models import TenantByDomainResponse
from ee.orbyte.server.tenants.models import TenantCreationPayload
from ee.orbyte.server.tenants.models import TenantDeletionPayload
from ee.orbyte.server.tenants.schema_management import create_schema_if_not_exists
from ee.orbyte.server.tenants.schema_management import drop_schema
from ee.orbyte.server.tenants.schema_management import run_alembic_migrations
from ee.orbyte.server.tenants.user_mapping import add_users_to_tenant
from ee.orbyte.server.tenants.user_mapping import get_tenant_id_for_email
from ee.orbyte.server.tenants.user_mapping import user_owns_a_tenant
from orbyte.auth.users import exceptions
from orbyte.configs.app_configs import ANTHROPIC_DEFAULT_API_KEY
from orbyte.configs.app_configs import AUTO_PROVISION_DEFAULT_LLM_PROVIDERS
from orbyte.configs.app_configs import COHERE_DEFAULT_API_KEY
from orbyte.configs.app_configs import CONTROL_PLANE_API_BASE_URL
from orbyte.configs.app_configs import DEV_MODE
from orbyte.configs.app_configs import OPENAI_DEFAULT_API_KEY
from orbyte.configs.app_configs import OPENROUTER_DEFAULT_API_KEY
from orbyte.configs.app_configs import VERTEXAI_DEFAULT_CREDENTIALS
from orbyte.configs.app_configs import VERTEXAI_DEFAULT_LOCATION
...
from orbyte.db.llm import fetch_existing_llm_provider_by_type_nameless
...
from orbyte.db.models import AvailableTenant
from orbyte.db.models import IndexModelStatus
from orbyte.db.models import SearchSettings
from orbyte.db.models import UserTenantMapping
from orbyte.llm.well_known_providers.auto_update_models import LLMRecommendations
from orbyte.llm.well_known_providers.constants import ANTHROPIC_PROVIDER_NAME
from orbyte.llm.well_known_providers.constants import OPENAI_PROVIDER_NAME
from orbyte.llm.well_known_providers.constants import OPENROUTER_PROVIDER_NAME
from orbyte.llm.well_known_providers.constants import VERTEX_CREDENTIALS_FILE_KWARG
from orbyte.llm.well_known_providers.constants import VERTEX_LOCATION_KWARG
from orbyte.llm.well_known_providers.constants import VERTEXAI_PROVIDER_NAME
from orbyte.llm.well_known_providers.llm_provider_options import get_recommendations
...
async def setup_tenant(tenant_id: str) -> None:
    ...
    try:
        ...
        with get_session_with_tenant(tenant_id=tenant_id) as db_session:
            ...
            # Set up Orbyte with appropriate settings
            ...
            setup_orbyte(db_session, tenant_id, cohere_enabled=cohere_enabled)
