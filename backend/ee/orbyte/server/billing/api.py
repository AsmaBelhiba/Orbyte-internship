...
See: https://linear.app/orbyte-app/issue/ENG-3533/migrate-tenantsbilling-adminbilling
"""
...
from ee.orbyte.db.license import get_used_seats
from ee.orbyte.server.billing.billing_cache import (
...
from ee.orbyte.server.billing.models import CreateCustomerPortalSessionRequest
from ee.orbyte.server.billing.models import CreateCustomerPortalSessionResponse
from ee.orbyte.server.billing.models import EndTrialResponse
...
from ee.orbyte.server.billing.models import StripePublishableKeyResponse
from ee.orbyte.server.billing.models import SubscriptionStatusResponse
from ee.orbyte.server.billing.service import (
    create_checkout_session as create_checkout_service,
)
from ee.orbyte.server.billing.service import (
    create_customer_portal_session as create_portal_service,
)
from ee.orbyte.server.billing.service import end_trial as end_trial_service
from ee.orbyte.server.billing.service import (
    get_billing_information as get_billing_service,
)
from ee.orbyte.server.billing.service import update_seat_count as update_seat_service
...
async def create_customer_portal_session(
    ...
    if not MULTI_TENANT and not license_data:
        raise OrbyteError(OrbyteErrorCode.VALIDATION_ERROR, "No license found")
...
async def get_billing_information(
    ...
    try:
        ...
        if e.status_code in (
            OrbyteErrorCode.BAD_GATEWAY.status_code,
            OrbyteErrorCode.SERVICE_UNAVAILABLE.status_code,
            OrbyteErrorCode.GATEWAY_TIMEOUT.status_code,
        ):
