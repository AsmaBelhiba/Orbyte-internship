...
from ee.orbyte.server.billing.models import StripePortalFlowType
...
async def _make_billing_request(
    ...
    try:
        ...
        raise OrbyteError(
            OrbyteErrorCode.BAD_GATEWAY, "Failed to connect to billing service"
        )
