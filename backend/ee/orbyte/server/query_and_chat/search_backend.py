"""Orbyte Search UI backend (/api/search/send-search-message et al.).

These endpoints power the "Orbyte Search" UI.  They call search_pipeline()
...
orbyte/server/features/search/api.py (POST /api/search).
"""
...
from ee.orbyte.db.search import fetch_search_queries_for_user
from ee.orbyte.search.process_search_query import gather_search_stream
from ee.orbyte.search.process_search_query import stream_search_query
from ee.orbyte.secondary_llm_flows.search_flow_classification import (
    classify_is_search_flow,
)
from ee.orbyte.server.query_and_chat.models import SearchFlowClassificationRequest
from ee.orbyte.server.query_and_chat.models import SearchFlowClassificationResponse
from ee.orbyte.server.query_and_chat.models import SearchFullResponse
from ee.orbyte.server.query_and_chat.models import SearchHistoryResponse
from ee.orbyte.server.query_and_chat.models import SearchQueryResponse
from ee.orbyte.server.query_and_chat.models import SendSearchQueryRequest
from ee.orbyte.server.query_and_chat.streaming_models import SearchErrorPacket
from orbyte.auth.permissions import require_permission
from orbyte.configs.app_configs import ORBYTE_SEARCH_UI_USES_OPENSEARCH_KEYWORD_SEARCH
...
# NOTE: This endpoint is used for the core flow of the Orbyte application, any
...
def handle_send_search_message(
    ...
    If hybrid_alpha is unset and ORBYTE_SEARCH_UI_USES_OPENSEARCH_KEYWORD_SEARCH
    ...
    if request.hybrid_alpha is None and ORBYTE_SEARCH_UI_USES_OPENSEARCH_KEYWORD_SEARCH:
