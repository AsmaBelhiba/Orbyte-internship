...
from ee.orbyte.server.enterprise_settings.models import AnalyticsScriptUpload
...
from orbyte.configs.constants import KV_ENTERPRISE_SETTINGS_KEY
...
def load_runtime_settings() -> EnterpriseSettings:
    ...
    if not enterprise_settings.application_name:
        enterprise_settings.application_name = ORBYTE_DEFAULT_APPLICATION_NAME
