...
from ee.orbyte.db.persona import update_persona_access
from ee.orbyte.db.user_group import add_users_to_user_group
from ee.orbyte.db.user_group import delete_user_group as db_delete_user_group
from ee.orbyte.db.user_group import fetch_user_group
from ee.orbyte.db.user_group import fetch_user_groups
from ee.orbyte.db.user_group import fetch_user_groups_for_user
from ee.orbyte.db.user_group import insert_user_group
from ee.orbyte.db.user_group import prepare_user_group_for_deletion
from ee.orbyte.db.user_group import rename_user_group
from ee.orbyte.db.user_group import set_group_permission__no_commit
from ee.orbyte.db.user_group import update_user_curator_relationship
from ee.orbyte.db.user_group import update_user_group
from ee.orbyte.server.user_group.models import AddUsersToUserGroupRequest
from ee.orbyte.server.user_group.models import MinimalUserGroupSnapshot
from ee.orbyte.server.user_group.models import SetCuratorRequest
from ee.orbyte.server.user_group.models import SetPermissionRequest
from ee.orbyte.server.user_group.models import SetPermissionResponse
from ee.orbyte.server.user_group.models import UpdateGroupAgentsRequest
from ee.orbyte.server.user_group.models import UserGroup
from ee.orbyte.server.user_group.models import UserGroupCreate
from ee.orbyte.server.user_group.models import UserGroupRename
from ee.orbyte.server.user_group.models import UserGroupUpdate
from orbyte.auth.permissions import NON_TOGGLEABLE_PERMISSIONS
...
def get_user_group_permissions(
    ...
    if group is None:
        raise OrbyteError(OrbyteErrorCode.NOT_FOUND, "User group not found")
    return [
...
def rename_user_group_endpoint(
    ...
    try:
        ...
        if "not found" in msg.lower():
            raise OrbyteError(OrbyteErrorCode.NOT_FOUND, msg)
        raise OrbyteError(OrbyteErrorCode.CONFLICT, msg)
