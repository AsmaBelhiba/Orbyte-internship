...
from orbyte.db.models import Credential__UserGroup
...
from orbyte.db.models import DocumentSet__UserGroup
from orbyte.db.models import FederatedConnector__DocumentSet
from orbyte.db.models import LLMProvider__UserGroup
from orbyte.db.models import MCPServer__UserGroup
from orbyte.db.models import PermissionGrant
...
from orbyte.db.models import TokenRateLimit__UserGroup
...
from orbyte.db.permissions import recompute_permissions_for_group__no_commit
...
def _validate_curator_can_modify_group(
    ...
    Raises ``OrbyteError(UNAUTHORIZED)`` if a curator / global_curator attempts to
