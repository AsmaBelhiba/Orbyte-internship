...
from orbyte.server.metrics.metrics_server import _DEFAULT_PORTS
...
def reset_server_state() -> Iterator[None]:
    ...
    import orbyte.server.metrics.metrics_server as mod
...
class TestStartMetricsServer:
    @patch("orbyte.server.metrics.metrics_server.start_http_server")
