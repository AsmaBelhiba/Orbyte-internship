...
from ee.orbyte.server.billing.models import BillingInformationResponse
from ee.orbyte.server.billing.models import CreateCheckoutSessionResponse
from ee.orbyte.server.billing.models import CreateCustomerPortalSessionResponse
from ee.orbyte.server.billing.models import SeatUpdateResponse
from ee.orbyte.server.billing.models import SubscriptionStatusResponse
...
class TestCreateCheckoutSession:
    ...
    @pytest.mark.asyncio
    @patch("ee.orbyte.server.billing.api.create_checkout_service")
    @patch("ee.orbyte.server.billing.api._get_tenant_id")
    @patch("ee.orbyte.server.billing.api._get_license_data")
    async def test_creates_checkout_session_cloud(
        ...
        from ee.orbyte.server.billing.api import create_checkout_session
        from ee.orbyte.server.billing.models import CreateCheckoutSessionRequest
    ...
    async def test_raises_on_service_error(
        ...
        """Should propagate OrbyteError when service fails."""
        from ee.orbyte.server.billing.api import create_checkout_session

        mock_get_license.return_value = None
        mock_get_tenant.return_value = "tenant_123"
        mock_service.side_effect = OrbyteError(
        ...
        assert exc_info.value.error_code is OrbyteErrorCode.BAD_GATEWAY
...
class TestCreateCustomerPortalSession:
    ...
    @pytest.mark.asyncio
    @patch("ee.orbyte.server.billing.api.MULTI_TENANT", False)
    @patch("ee.orbyte.server.billing.api.create_portal_service")
    @patch("ee.orbyte.server.billing.api._get_tenant_id")
    @patch("ee.orbyte.server.billing.api._get_license_data")
    async def test_requires_license_for_self_hosted(
        ...
        from ee.orbyte.server.billing.api import create_customer_portal_session
        ...
        assert exc_info.value.error_code is OrbyteErrorCode.VALIDATION_ERROR
...
class TestGetBillingInformation:
    ...
    async def test_returns_not_subscribed_without_license(
        ...
        from ee.orbyte.server.billing.api import get_billing_information
    ...
    @pytest.mark.asyncio
    @patch("ee.orbyte.server.billing.api.get_billing_service")
    @patch("ee.orbyte.server.billing.api._get_tenant_id")
    @patch("ee.orbyte.server.billing.api._get_license_data")
...
class TestUpdateSeats:
    ...
    async def test_requires_license_for_self_hosted(
        ...
        """Should reject self-hosted without license."""
        from ee.orbyte.server.billing.api import update_seats
    ...
    @pytest.mark.asyncio
    @patch("ee.orbyte.server.billing.api.get_used_seats")
    @patch("ee.orbyte.server.billing.api.update_seat_service")
    @patch("ee.orbyte.server.billing.api._get_tenant_id")
    @patch("ee.orbyte.server.billing.api._get_license_data")
    ...
    async def test_handles_billing_service_error(
        ...
        """Should propagate OrbyteError from service layer."""
        from ee.orbyte.server.billing.api import update_seats
        from ee.orbyte.server.billing.models import SeatUpdateRequest
...
class TestCircuitBreaker:
    ...
    @pytest.mark.asyncio
    @patch("ee.orbyte.server.billing.api.MULTI_TENANT", False)
    @patch("ee.orbyte.server.billing.api._is_billing_circuit_open")
    @patch("ee.orbyte.server.billing.api._get_tenant_id")
    @patch("ee.orbyte.server.billing.api._get_license_data")
    async def test_returns_503_when_circuit_open(
        ...
        assert exc_info.value.error_code is OrbyteErrorCode.SERVICE_UNAVAILABLE
        assert "Connect to Stripe" in exc_info.value.detail

    @pytest.mark.asyncio
    @patch("ee.orbyte.server.billing.api.MULTI_TENANT", False)
    @patch("ee.orbyte.server.billing.api._open_billing_circuit")
    @patch("ee.orbyte.server.billing.api._is_billing_circuit_open")
    @patch("ee.orbyte.server.billing.api.get_billing_service")
    @patch("ee.orbyte.server.billing.api._get_tenant_id")
    @patch("ee.orbyte.server.billing.api._get_license_data")
...
class TestResetConnection:
    ...
    @pytest.mark.asyncio
    @patch("ee.orbyte.server.billing.api.MULTI_TENANT", False)
    @patch("ee.orbyte.server.billing.api._close_billing_circuit")
    async def test_closes_circuit_for_self_hosted(
        ...
        from ee.orbyte.server.billing.api import reset_stripe_connection
    ...
    @pytest.mark.asyncio
    @patch("ee.orbyte.server.billing.api.MULTI_TENANT", True)
    @patch("ee.orbyte.server.billing.api._close_billing_circuit")
