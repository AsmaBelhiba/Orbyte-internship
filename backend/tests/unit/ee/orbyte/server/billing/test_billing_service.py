...
class TestMakeBillingRequest:
    ...
    @pytest.mark.asyncio
    @patch("ee.orbyte.server.billing.service._get_headers")
    @patch("ee.orbyte.server.billing.service._get_base_url")
    async def test_makes_post_request(
        ...
        from ee.orbyte.server.billing.service import _make_billing_request
    ...
    async def test_raises_on_http_error(
        ...
        """Should raise OrbyteError on HTTP error."""
        from ee.orbyte.server.billing.service import _make_billing_request
    ...
    async def test_raises_on_connection_error(
        ...
        """Should raise OrbyteError on connection error."""
        from ee.orbyte.server.billing.service import _make_billing_request
...
class TestCreateCheckoutSession:
    ...
    @pytest.mark.asyncio
    @patch("ee.orbyte.server.billing.service._make_billing_request")
    async def test_creates_checkout_session(
        self,
        mock_request: AsyncMock,
    ) -> None:
        """Should create checkout session and return URL."""
        from ee.orbyte.server.billing.service import create_checkout_session
    ...
    async def test_raises_when_no_url_returned(
        ...
        assert exc_info.value.error_code is OrbyteErrorCode.INTERNAL_ERROR
...
class TestCreateCustomerPortalSession:
    ...
    async def test_creates_portal_session(
        ...
        from ee.orbyte.server.billing.service import create_customer_portal_session
...
class TestGetBillingInformation:
    ...
    async def test_returns_billing_info(
        ...
        from ee.orbyte.server.billing.service import get_billing_information
...
class TestUpdateSeatCount:
    ...
    async def test_updates_seats(
        ...
        from ee.orbyte.server.billing.service import update_seat_count
    ...
    async def test_includes_tenant_id_for_cloud(
        ...
        with patch("ee.orbyte.server.billing.service.MULTI_TENANT", True):
