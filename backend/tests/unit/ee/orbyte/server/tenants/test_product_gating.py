...
class TestIsTenantGated:
    ...
    @patch("ee.orbyte.server.tenants.product_gating.get_redis_replica_client")
...
class TestUpdateTenantGating:
    ...
    @patch("ee.orbyte.server.tenants.product_gating.get_redis_client")
    def test_gating_set_modification(
        ...
        from ee.orbyte.server.tenants.product_gating import update_tenant_gating
