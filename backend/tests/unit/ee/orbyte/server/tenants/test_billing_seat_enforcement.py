...
surfacing as ``OrbyteError(SEAT_LIMIT_EXCEEDED)``).
"""
...
from ee.orbyte.server.tenants.billing import _seat_billing_idempotency_key
from ee.orbyte.server.tenants.billing import attempt_seat_billing_increase
from ee.orbyte.server.tenants.billing import enforce_cloud_seat_limit
from ee.orbyte.server.tenants.billing import SeatBillingDeclineReason
from orbyte.error_handling.error_codes import OrbyteErrorCode
from orbyte.error_handling.exceptions import OrbyteError

_BILLING = "ee.orbyte.server.tenants.billing"
...
class TestEnforceCloudSeatLimit:
    ...
    @patch("ee.orbyte.server.tenants.user_mapping.get_tenant_count")
    ...
    def test_decline_raises_seat_limit_exceeded(
        ...
        assert exc.value.error_code == OrbyteErrorCode.SEAT_LIMIT_EXCEEDED
