...
@patch("ee.orbyte.db.user_group.recompute_user_permissions__no_commit")
@patch("ee.orbyte.db.user_group._add_user__user_group_relationships__no_commit")
@patch("ee.orbyte.db.user_group.fetch_user_by_id", return_value=MagicMock())
@patch("ee.orbyte.db.user_group._check_user_group_is_modifiable")
...
@patch("ee.orbyte.db.user_group.recompute_user_permissions__no_commit")
@patch("ee.orbyte.db.user_group._add_user_group__cc_pair_relationships__no_commit")
@patch(
    "ee.orbyte.db.user_group._mark_user_group__cc_pair_relationships_outdated__no_commit"
)
@patch("ee.orbyte.db.user_group._check_user_group_is_modifiable")
