...
from ee.orbyte.db.license import delete_license
...
from orbyte.db.models import License
...
class TestCheckSeatAvailabilitySelfHosted:
    ...
    @patch("ee.orbyte.db.license.get_license_metadata", return_value=None)
    ...
    @patch("ee.orbyte.db.license.get_used_seats", return_value=5)
    @patch("ee.orbyte.db.license.get_license_metadata")
    ...
    @patch("ee.orbyte.db.license.get_used_seats", return_value=10)
    @patch("ee.orbyte.db.license.get_license_metadata")
    ...
    @patch("ee.orbyte.db.license.get_used_seats", return_value=9)
    @patch("ee.orbyte.db.license.get_license_metadata")
...
class TestCheckSeatAvailabilityMultiTenant:
    ...
    @patch("ee.orbyte.db.license.MULTI_TENANT", True)
    @patch(
        "ee.orbyte.server.tenants.user_mapping.get_tenant_count",
        return_value=5,
    )
    @patch("ee.orbyte.db.license.get_license_metadata")
