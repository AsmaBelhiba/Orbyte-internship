"""Unit tests for the client-IP enrichment in ee.orbyte.utils.telemetry."""

from unittest.mock import MagicMock

from ee.orbyte.utils import telemetry as ee_telemetry
from orbyte.utils import client_ip as client_ip_mod
