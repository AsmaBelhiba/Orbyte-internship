...
from ee.orbyte.external_permissions.google_drive.group_sync import _get_drive_members
...
@patch("ee.orbyte.external_permissions.google_drive.group_sync.get_drive_service")
