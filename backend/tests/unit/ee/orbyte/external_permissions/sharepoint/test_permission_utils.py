...
from ee.orbyte.external_permissions.sharepoint.permission_utils import (
    _enumerate_ad_groups_paginated,
)
from ee.orbyte.external_permissions.sharepoint.permission_utils import _is_public_item
from ee.orbyte.external_permissions.sharepoint.permission_utils import (
    _iter_graph_collection,
)
from ee.orbyte.external_permissions.sharepoint.permission_utils import _normalize_email
from ee.orbyte.external_permissions.sharepoint.permission_utils import (
...
from ee.orbyte.external_permissions.sharepoint.permission_utils import GroupsResult

MODULE = "ee.orbyte.external_permissions.sharepoint.permission_utils"
