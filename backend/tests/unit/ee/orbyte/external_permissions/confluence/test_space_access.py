...
The companion file `backend/tests/unit/orbyte/connectors/confluence/test_orbyte_confluence.py`
covers the OrbyteConfluence client methods (REST 404/500 handling, version
probe, userKey-email cache). Tests here cover the EE-side dispatcher in
`ee/orbyte/external_permissions/confluence/space_access.py` -- which path
