...
@patch("orbyte.document_index.vespa.vespa_document_index.batch_index_vespa_chunks")
@patch("orbyte.document_index.vespa.vespa_document_index.delete_vespa_chunks")
@patch(
    "orbyte.document_index.vespa.vespa_document_index.get_document_chunk_ids",
    return_value=[],
)
@patch("orbyte.document_index.vespa.vespa_document_index._enrich_basic_chunk_info")
@patch(
    "orbyte.document_index.vespa.vespa_document_index.BATCH_SIZE",
    3,
)
