...
from orbyte.chat.process_message import determine_search_params
from orbyte.chat.process_message import extract_context_files
from orbyte.chat.process_message import resolve_context_user_files
...
class TestResolveContextUserFiles:
    ...
    @patch("orbyte.chat.process_message.get_user_files_from_project")
...
class TestExtractContextFiles:
    ...
    @patch("orbyte.chat.process_message.load_in_memory_chat_files")
    ...
    @patch("orbyte.chat.process_message.DISABLE_VECTOR_DB", True)
