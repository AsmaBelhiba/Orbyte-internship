...
from orbyte.chat.compression import _build_llm_messages_for_summarization
from orbyte.chat.compression import find_summary_for_branch
from orbyte.chat.compression import generate_summary
from orbyte.chat.compression import get_compression_params
from orbyte.chat.compression import get_messages_to_summarize
from orbyte.chat.compression import SummaryContent
...
from orbyte.prompts.compression_prompts import PROGRESSIVE_SUMMARY_SYSTEM_PROMPT_BLOCK
from orbyte.prompts.compression_prompts import PROGRESSIVE_USER_REMINDER
from orbyte.prompts.compression_prompts import SUMMARIZATION_CUTOFF_MARKER
from orbyte.prompts.compression_prompts import SUMMARIZATION_PROMPT
from orbyte.prompts.compression_prompts import USER_REMINDER
...
def test_generate_summary_initial_system_prompt() -> None:
    ...
    with patch("orbyte.chat.compression.llm_generation_span"):
