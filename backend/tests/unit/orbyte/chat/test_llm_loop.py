...
from orbyte.chat.llm_loop import _build_empty_llm_response_error
from orbyte.chat.llm_loop import _try_fallback_tool_extraction
from orbyte.chat.llm_loop import construct_message_history
from orbyte.chat.llm_loop import EmptyLLMResponseError
from orbyte.chat.llm_loop import select_reminder_text
    ...
    def test_extracts_xml_style_invoke_from_answer_when_required(self) -> None:
        llm_step_result = LlmStepResult(
            ...
            answer=(
                ...
                '["Orbyte documentation", "Orbyte docs", "Orbyte platform"]'
    ...
    def test_extracts_xml_style_invoke_from_answer_when_auto(self) -> None:
        llm_step_result = LlmStepResult(
            ...
            raw_answer=(
                '<function_calls><invoke name="internal_search">'
                '<parameter name="queries" string="false">'
                '["Orbyte documentation", "Orbyte docs", "Orbyte internal docs"]'
                "</parameter></invoke></function_calls>"
            ),
            tool_calls=None,
        )
        ...
        assert result.tool_calls[0].tool_name == "internal_search"
        assert result.tool_calls[0].tool_args == {
            "queries": ["Orbyte documentation", "Orbyte docs", "Orbyte internal docs"]
        }
    ...
    def test_extracts_from_raw_answer_when_filtered_answer_has_no_xml(self) -> None:
        llm_step_result = LlmStepResult(
            ...
            raw_answer=(
                '<function_calls><invoke name="internal_search">'
                '<parameter name="queries" string="false">'
                '["Orbyte documentation", "Orbyte docs"]'
                "</parameter></invoke></function_calls>"
            ),
            tool_calls=None,
        )
        ...
        assert result.tool_calls[0].tool_name == "internal_search"
        assert result.tool_calls[0].tool_args == {
            "queries": ["Orbyte documentation", "Orbyte docs"]
        }
