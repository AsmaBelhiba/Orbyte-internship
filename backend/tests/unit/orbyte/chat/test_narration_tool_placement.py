...
The fix (orbyte/chat/llm_step.py) shifts the tool call to the next tab_index when
...
@patch("orbyte.chat.llm_step.translate_history_to_llm_format", return_value=[])
