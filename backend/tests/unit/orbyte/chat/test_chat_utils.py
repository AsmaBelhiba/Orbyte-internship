...
from orbyte.chat.chat_utils import _build_tool_call_response_history_message
from orbyte.chat.chat_utils import _get_or_extract_plaintext
...
class TestGetOrExtractPlaintext:
    ...
    def test_cache_hit_skips_extraction(self) -> None:
        ...
        with (
            patch(
                "orbyte.chat.chat_utils.get_default_file_store",
                return_value=file_store,
            ),
            patch("orbyte.chat.chat_utils.store_plaintext") as store_plaintext,
        ):
