...
pattern). Emission itself is covered in tests/unit/orbyte/utils/test_audit.py.
"""
...
@pytest.mark.asyncio
@patch("orbyte.auth.users.mt_cloud_identify_user")
...
@pytest.mark.asyncio
@patch("orbyte.auth.users.send_forgot_password_email")
@patch("orbyte.auth.users.fetch_ee_implementation_or_noop")
@patch("orbyte.auth.users.EMAIL_CONFIGURED", True)
...
@pytest.mark.asyncio
@patch("orbyte.auth.users.send_user_verification_email")
@patch("orbyte.auth.users.get_user_count", new_callable=AsyncMock)
@patch("orbyte.auth.users.get_security_settings")
