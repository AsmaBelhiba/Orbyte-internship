...
from orbyte.llm.model_capabilities import find_model_obj
from orbyte.llm.model_capabilities import get_model_map
...
def test_no_overwrite_in_model_map() -> None:
    ...
    # Create a mock model_cost dict with multiple entries for "orbyte-llm"
