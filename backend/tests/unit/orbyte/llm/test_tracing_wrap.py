# ruff: noqa: ARG002
"""Unit tests for `orbyte.llm.tracing_wrap`.
...
from orbyte.llm.model_response import FunctionCall as DeltaFunctionCall
...
from orbyte.llm.tracing_wrap import _ALREADY_WRAPPED_ATTR
from orbyte.llm.tracing_wrap import _extract_prompt_and_tools
from orbyte.llm.tracing_wrap import _finalize_tool_calls
from orbyte.llm.tracing_wrap import _merge_tool_call_delta
from orbyte.llm.tracing_wrap import _outer_generation_span_active
from orbyte.llm.tracing_wrap import _validate_prompt_param
from orbyte.llm.tracing_wrap import wrap_invoke
from orbyte.llm.tracing_wrap import wrap_stream
...
def test_stream_records_usage_when_consumer_abandons_generator() -> None:
    ...
    llm = _UsageStreamLLM()
    with patch("orbyte.tracing.llm_utils.record_llm_span_output") as recorder:
        gen = cast(
