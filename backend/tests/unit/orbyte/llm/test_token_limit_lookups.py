"""Tests for the token-limit lookup helpers in `orbyte.llm.model_capabilities`:
`llm_max_input_tokens`, `get_llm_max_output_tokens`, and `get_max_input_tokens`."""

from unittest.mock import patch

from orbyte.configs.model_configs import GEN_AI_MODEL_FALLBACK_MAX_TOKENS
from orbyte.llm.model_capabilities import get_llm_max_output_tokens
from orbyte.llm.model_capabilities import get_max_input_tokens
from orbyte.llm.model_capabilities import llm_max_input_tokens
...
class TestLlmMaxInputTokens:
    ...
    def test_override_env_var_wins(self) -> None:
        ...
        with patch("orbyte.llm.model_capabilities.GEN_AI_MAX_TOKENS", 5000):
            assert (
                llm_max_input_tokens(
                    model_map=model_map,
                    model_name="gpt-4o",
