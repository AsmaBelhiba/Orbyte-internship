"""Tests for OrbyteWebCrawler's Playwright fallback on Cloudflare/bot challenges.
...
def test_403_triggers_playwright_fallback(
    ...
    result = OrbyteWebCrawler()._fetch_url("https://example.com/")
...
def test_4xx_with_cf_mitigated_triggers_playwright_fallback(
    ...
    OrbyteWebCrawler()._fetch_url("https://example.com/")
...
def test_404_without_cloudflare_signals_skips_playwright_fallback(
    ...
    result = OrbyteWebCrawler()._fetch_url("https://example.com/missing")
...
def test_401_without_cloudflare_signals_skips_playwright_fallback(
    ...
    OrbyteWebCrawler()._fetch_url("https://example.com/private")
...
def test_fallback_disabled_skips_playwright(
    ...
    crawler = OrbyteWebCrawler(playwright_fallback_enabled=False)
...
def test_fallback_respects_max_html_size(
    ...
    crawler = OrbyteWebCrawler(max_html_size_bytes=100)
    result = crawler._fetch_url("https://example.com/")
...
def test_ssrf_failure_reason(mock_get: MagicMock) -> None:
    ...
    result = OrbyteWebCrawler()._fetch_url("http://internal.local/")
