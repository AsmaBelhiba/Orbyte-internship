...
from orbyte.tools.tool_implementations.web_search.web_search_tool import (
...
def _make_tool(mock_provider: Any) -> WebSearchTool:
    ...
    with (
        patch(
            "orbyte.tools.tool_implementations.web_search.web_search_tool.get_session_with_current_tenant"
        ) as mock_session_ctx,
        patch(
            "orbyte.tools.tool_implementations.web_search.web_search_tool.fetch_active_web_search_provider",
