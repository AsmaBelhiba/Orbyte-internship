...
from orbyte.tools.models import PythonToolOverrideKwargs
...
class TestChatFileConversion:
    ...
    def test_context_tabular_user_files_loaded_for_tools(self) -> None:
        ...
        from orbyte.chat.process_message import _load_context_user_files_for_tools
        ...
        with patch(
            "orbyte.chat.process_message.get_default_file_store"
