...
from orbyte.connectors.salesforce.connector import _convert_to_metadata_value
...
class TestYieldDocBatches:
    ...
    def mock_sf_db(self) -> MagicMock:
        """Create a mock OrbyteSalesforceSQLite object."""
        return MagicMock()
    ...
    @patch("orbyte.connectors.salesforce.connector.convert_sf_object_to_doc")
