...
from orbyte.connectors.asana.asana_api import AsanaAPI
from orbyte.connectors.asana.connector import AsanaConnector
...
def _build_api_with_mocks(
    ...
    *,
    ...
    """
    with patch("orbyte.connectors.asana.asana_api.asana"):
