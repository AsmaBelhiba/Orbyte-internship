...
from orbyte.connectors.jira.connector import JiraConnectorCheckpoint
from orbyte.connectors.jira.utils import JIRA_SERVER_API_VERSION
...
def jira_connector(
    ...
    with patch("orbyte.connectors.jira.connector._JIRA_FULL_PAGE_SIZE", 2):
        yield connector
...
def test_load_from_checkpoint_with_issue_processing_error(
    ...
    with patch("orbyte.connectors.jira.connector.process_jira_issue") as mock_process:
