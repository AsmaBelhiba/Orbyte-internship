...
from orbyte.connectors.slab.connector import SlabConnector
...
@patch("orbyte.connectors.slab.connector.get_all_post_ids", return_value=["id1"])
...
@patch(
    "orbyte.connectors.slab.connector.get_all_post_ids",
