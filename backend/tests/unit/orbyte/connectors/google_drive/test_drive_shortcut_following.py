...
from orbyte.connectors.google_drive.doc_conversion import download_request
from orbyte.connectors.google_drive.file_retrieval import _get_files_in_parent
...
from orbyte.connectors.google_drive.file_retrieval import DRIVE_RESOURCE_KEY_HEADER
...
_FILE_RETRIEVAL_MODULE = "orbyte.connectors.google_drive.file_retrieval"
...
def test_resource_key_download_uses_header() -> None:
    ...
    with patch(
        "orbyte.connectors.google_drive.doc_conversion._download_request",
