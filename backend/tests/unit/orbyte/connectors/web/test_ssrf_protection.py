...
from orbyte.connectors.web import connector as web_connector
from orbyte.connectors.web.connector import check_internet_connection
from orbyte.connectors.web.connector import extract_urls_from_sitemap
