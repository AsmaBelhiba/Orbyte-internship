...
def _skip_web_connector_ssrf_check(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "orbyte.connectors.web.connector.protected_url_check", lambda _url: None
    )
...
@patch("orbyte.connectors.web.connector.check_internet_connection")
@patch("orbyte.connectors.web.connector.requests.head")
@patch("orbyte.connectors.web.connector.start_playwright")
...
def test_slim_skips_content_extraction(
    ...
    with patch("orbyte.connectors.web.connector.web_html_cleanup") as mock_cleanup:
...
@patch("orbyte.connectors.web.connector.time")
@patch("orbyte.connectors.web.connector.check_internet_connection")
@patch("orbyte.connectors.web.connector.requests.head")
@patch("orbyte.connectors.web.connector.start_playwright")
