...
from orbyte.connectors.factory import _connector_cache
from orbyte.connectors.factory import _load_connector_class
...
from orbyte.connectors.registry import CONNECTOR_CLASS_MAP
from orbyte.connectors.registry import ConnectorMapping
...
class TestConnectorClassLoading:
    ...
    def test_load_connector_class_import_error(self, mock_import: Mock) -> None:
        ...
        assert (
            "Failed to import WebConnector from orbyte.connectors.web.connector"
...
class TestConnectorMappingIntegrity:
    ...
    def test_mapping_format_consistency(self) -> None:
        ...
        for source, mapping in CONNECTOR_CLASS_MAP.items():
            ...
            assert mapping.module_path.startswith("orbyte.connectors."), (
                f"{source.value} module_path doesn't start with orbyte.connectors."
            )
...
class TestValidateCCPairForUser:
    def test_validate_settings_error_raises_connector_validation_error(self) -> None:
        ...
        with (
            patch(
                "orbyte.connectors.factory.fetch_connector_by_id",
            ...
            patch(
                "orbyte.connectors.factory.fetch_credential_by_id",
                return_value=MagicMock(),
            ),
            patch(
                "orbyte.connectors.factory.instantiate_connector",
