...
from orbyte.connectors.teams.utils import _backoff_seconds
from orbyte.connectors.teams.utils import execute_query_with_retry
from orbyte.connectors.teams.utils import GRAPH_API_RETRYABLE_STATUSES
...
def test_returns_result_without_retry_on_success() -> None:
    ...
    with patch("orbyte.connectors.teams.utils.time.sleep") as mock_sleep:
