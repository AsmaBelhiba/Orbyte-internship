...
from orbyte.connectors.teams.connector import _collect_all_teams
...
def test_helper_functions() -> None:
    ...
    from orbyte.connectors.teams.connector import _can_use_odata_filter
    from orbyte.connectors.teams.connector import _escape_odata_string
    from orbyte.connectors.teams.connector import _has_odata_incompatible_chars
