...
@patch("orbyte.connectors.sharepoint.connector.msal.ConfidentialClientApplication")
@patch("orbyte.connectors.sharepoint.connector.GraphClient")
...
@patch("orbyte.connectors.sharepoint.connector.load_certificate_from_pfx")
@patch("orbyte.connectors.sharepoint.connector.msal.ConfidentialClientApplication")
@patch("orbyte.connectors.sharepoint.connector.GraphClient")
