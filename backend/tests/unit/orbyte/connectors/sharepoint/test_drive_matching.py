...
from orbyte.connectors.sharepoint.connector import SHARED_DOCUMENTS_MAP
from orbyte.connectors.sharepoint.connector import SharepointConnector
from orbyte.connectors.sharepoint.connector import SharepointConnectorCheckpoint
from orbyte.connectors.sharepoint.connector import SiteDescriptor
...
def test_load_from_checkpoint_maps_drive_name(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "orbyte.connectors.sharepoint.connector._convert_driveitem_to_document_with_permissions",
        fake_convert,
    )
    monkeypatch.setattr(
        SharepointConnector,
