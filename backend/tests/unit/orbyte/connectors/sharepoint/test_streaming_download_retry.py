...
from orbyte.connectors.sharepoint import connector as sp_connector
from orbyte.connectors.sharepoint.connector import _download_via_graph_api
from orbyte.connectors.sharepoint.connector import _download_with_cap
from orbyte.connectors.sharepoint.connector import _redact_url_for_logging
from orbyte.connectors.sharepoint.connector import SizeCapExceeded
...
@patch("orbyte.connectors.sharepoint.connector.time")
...
@patch("orbyte.connectors.sharepoint.connector.time")
@patch("orbyte.connectors.sharepoint.connector.logger")
@patch("orbyte.connectors.sharepoint.connector.requests.get")
