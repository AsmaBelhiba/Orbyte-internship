...
@patch("orbyte.connectors.sharepoint.connector._convert_sitepage_to_slim_document")
@patch(
    "orbyte.connectors.sharepoint.connector.SharepointConnector._create_rest_client_context"
)
@patch("orbyte.connectors.sharepoint.connector.SharepointConnector._fetch_site_pages")
@patch("orbyte.connectors.sharepoint.connector.SharepointConnector._fetch_driveitems")
@patch("orbyte.connectors.sharepoint.connector.SharepointConnector.fetch_sites")
...
def test_retrieve_all_slim_docs_does_not_fetch_permissions(
    ...
    from orbyte.connectors.models import SlimDocument
    from orbyte.connectors.sharepoint.connector import DriveItemData
...
@patch("orbyte.connectors.sharepoint.connector.requests.get")
@patch("orbyte.connectors.sharepoint.connector.acquire_token_for_rest")
...
def test_probe_role_assignments_caps_probed_sites(
    ...
    from orbyte.connectors.sharepoint.connector import ROLE_ASSIGNMENTS_PROBE_MAX_SITES
...
@patch("orbyte.connectors.sharepoint.connector.requests.get")
@patch(
    "orbyte.connectors.sharepoint.connector.SharepointConnector._get_graph_access_token"
)
