...
Reproduces the production traceback:
    ...
    File "/app/orbyte/connectors/freshdesk/connector.py", line 131
...
from orbyte.connectors.freshdesk.connector import _create_doc_from_ticket
from orbyte.connectors.freshdesk.connector import _create_metadata_from_ticket
