...
from orbyte.connectors.slack.connector import _channel_team_id
from orbyte.connectors.slack.connector import _channel_to_hierarchy_node
from orbyte.connectors.slack.connector import channel_team_ids
from orbyte.connectors.slack.connector import fetch_team_url
...
class TestListGridTeamIds:
    def test_returns_team_ids_from_paginated_response(self) -> None:
        with patch(
            "orbyte.connectors.slack.connector.make_paginated_slack_api_call"
        ) as mock_paginate:
...
class TestGetMessageLinkTeamAware:
    ...
    def test_falls_back_to_get_base_url_when_team_id_to_url_missing(self) -> None:
        ...
        with patch(
            "orbyte.connectors.slack.utils.get_base_url",
