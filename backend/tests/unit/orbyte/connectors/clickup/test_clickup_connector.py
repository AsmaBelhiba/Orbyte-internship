...
from orbyte.connectors.clickup.connector import CLICKUP_API_BASE_URL
from orbyte.connectors.clickup.connector import ClickupConnector
...
def test_get_all_tasks_filtered_uses_relative_endpoint() -> None:
    ...
    with patch("orbyte.connectors.clickup.connector.requests.get") as mock_get:
