...
from ee.orbyte.external_permissions.confluence.page_access import (
...
from orbyte.connectors.confluence.orbyte_confluence import _is_confcloud_77618_response
...
@pytest.fixture
def cloud_client(mock_credentials_provider: mock.Mock) -> OrbyteConfluence:
...
# ---------------------------------------------------------------------------
# OrbyteConfluence.fetch_content_read_restrictions (byOperation endpoint)
# ---------------------------------------------------------------------------
...
def test_pruning_expand_skips_restrictions_but_keeps_hierarchy(
    ...
    fake_client = mock.Mock(spec=OrbyteConfluence)
...
def test_per_ancestor_fetch_short_circuits_on_page_level_restriction() -> None:
    ...
    client = mock.Mock(spec=OrbyteConfluence)
