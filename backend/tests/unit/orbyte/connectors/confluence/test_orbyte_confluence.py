...
from orbyte.connectors.confluence import orbyte_confluence as orbyte_confluence_module
from orbyte.connectors.confluence.orbyte_confluence import _DEFAULT_PAGINATION_LIMIT
from orbyte.connectors.confluence.orbyte_confluence import _MINIMUM_PAGINATION_LIMIT
...
@pytest.fixture
def confluence_server_client(mock_credentials_provider: mock.Mock) -> OrbyteConfluence:
    confluence = OrbyteConfluence(
        is_cloud=False,
...
def test_cql_paginate_all_expansions_handles_internal_pagination_error(
    confluence_server_client: OrbyteConfluence, caplog: pytest.LogCaptureFixture
) -> None:
    """
...
def test_paginated_cql_retrieval_cloud_reduces_limit_on_error(
    ...
    """
    confluence_cloud_client = OrbyteConfluence(
        is_cloud=True,
...
def test_paginate_url_reduces_limit_on_500_server(
    confluence_server_client: OrbyteConfluence,
) -> None:
    """
...
def test_get_user_email_from_userkey_caches_lookups(
    ...
    orbyte_confluence_module._USER_KEY_TO_EMAIL_CACHE.clear()
