...
from orbyte.connectors.exceptions import CredentialInvalidError
...
@patch("orbyte.connectors.discord.connector.Client.close", new_callable=AsyncMock)
@patch("orbyte.connectors.discord.connector.Client.login", new_callable=AsyncMock)
...
@patch("orbyte.connectors.discord.connector.Client.close", new_callable=AsyncMock)
@patch(
    "orbyte.connectors.discord.connector.Client.login",
