"""Unit tests for :mod:`orbyte.server.features.build.sandbox.opencode.event_bus`.
...
from orbyte.server.features.build.sandbox.opencode import event_bus as event_bus_mod
from orbyte.server.features.build.sandbox.opencode.event_bus import _extract_session_id
from orbyte.server.features.build.sandbox.opencode.event_bus import _parse_sse_block
