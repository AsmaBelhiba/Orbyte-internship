...
from orbyte.server.features.build.sandbox import factory as factory_module
...
def test_docker_backend_returns_docker_manager(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    from orbyte.server.features.build.sandbox.docker import docker_sandbox_manager
