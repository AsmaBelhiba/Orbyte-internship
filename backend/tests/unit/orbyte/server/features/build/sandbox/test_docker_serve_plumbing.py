...
import orbyte.server.features.build.sandbox.docker.dev_mode_serve as dev_mode_serve
    ...
    fake_container.attrs = {
        "Config": {
            "Env": [
                ...
                "ORBYTE_SERVER_URL=http://api_server:8080",
...
def test_provision_generates_fresh_password_and_injects_into_container_env(
    ...
    """
    monkeypatch.setattr(dsm, "DEV_MODE", True)
    monkeypatch.setattr(dsm, "SANDBOX_API_SERVER_URL", "https://orbyte.example.com")
    ...
    mgr._network_name = "orbyte_craft_sandbox"  # type: ignore[attr-defined]
