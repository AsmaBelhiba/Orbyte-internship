...
from orbyte.server.features.build.external_apps import api as external_apps_api
from orbyte.skills.ingest import IngestedBundle
...
def test_create_custom_external_app_cleans_new_bundle_on_failure(
    ...
    monkeypatch.setattr(
        "orbyte.skills.ingest.ingest_skill_bundle",
    ...
    monkeypatch.setattr("orbyte.skills.ingest.delete_bundle_blob", delete_bundle_blob)
