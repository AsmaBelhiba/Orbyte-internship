...
Orbyte model configs: context length and vision (from architecture.modality).
"""
...
from orbyte.server.manage.llm.api import get_nebius_tokenfactory_available_models
...
def _fetch(sample: dict | None = None) -> dict:
    with (
        patch("orbyte.server.manage.llm.api._resolve_api_key", return_value="k"),
        patch(
            "orbyte.server.manage.llm.api._get_nebius_tokenfactory_models_response",
