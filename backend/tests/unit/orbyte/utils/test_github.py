"""Unit tests for orbyte.utils.github."""
...
from orbyte.utils.github import GITHUB_TARBALL_URL
from orbyte.utils.github import parse_github_repo
...
class TestDownloadGithubRepo:
    ...
    def test_skips_empty_keepalive_chunks(self) -> None:
        ...
        with patch("orbyte.utils.github.requests.get", return_value=response):
    ...
    def test_invalid_repo_raises_before_request(self) -> None:
        with patch("orbyte.utils.github.requests.get") as mock_get:
            with pytest.raises(ValueError):
