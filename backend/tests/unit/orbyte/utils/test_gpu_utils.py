"""
Test cases for orbyte/utils/gpu_utils.py with DISABLE_MODEL_SERVER environment variable
"""
...
from orbyte.utils.gpu_utils import _get_gpu_status_from_model_server
