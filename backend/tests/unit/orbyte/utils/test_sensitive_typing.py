...
Run with: mypy tests/unit/orbyte/utils/test_sensitive_typing.py --ignore-missing-imports
...
def demonstrate_incorrect_usage() -> None:
    ...
    from orbyte.utils.sensitive import SensitiveValue
    from orbyte.utils.encryption import encrypt_string_to_bytes, decrypt_bytes_to_string
