...
from orbyte.utils.url import _is_ip_private_or_reserved
from orbyte.utils.url import _validate_and_resolve_url
...
class TestValidateAndResolveUrl:
    ...
    def test_valid_http_scheme(self) -> None:
        ...
        with patch("orbyte.utils.url.socket.getaddrinfo") as mock_getaddrinfo:
...
class TestSsrfSafeGet:
    ...
    def test_makes_request_to_validated_ip_http(self) -> None:
        ...
        with patch("orbyte.utils.url.socket.getaddrinfo") as mock_getaddrinfo:
            ...
            with patch("orbyte.utils.url.requests.get") as mock_get:
...
class TestValidateOutboundHttpUrl:
    ...
    def test_blocks_dns_name_resolving_to_aws_metadata_with_floor(self) -> None:
        ...
        IAM credentials from a cloud-hosted Orbyte deployment, even when the
