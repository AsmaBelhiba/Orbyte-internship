...
from orbyte.orbytebot.discord.cache import TenantDiscordData
...
class TestCacheInitialization:
    ...
    async def test_cache_refresh_all_loads_guilds(self) -> None:
        ...
        with (
            patch(
                "orbyte.orbytebot.discord.cache.get_all_tenant_ids",
            ...
            patch(
                "orbyte.orbytebot.discord.cache.get_or_create_discord_service_api_key",
