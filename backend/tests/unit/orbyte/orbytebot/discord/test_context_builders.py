...
from orbyte.orbytebot.discord.handle_message import _build_conversation_context
from orbyte.orbytebot.discord.handle_message import _build_reply_chain_context
from orbyte.orbytebot.discord.handle_message import _build_thread_context
from orbyte.orbytebot.discord.handle_message import _format_messages_as_context
from orbyte.orbytebot.discord.handle_message import format_message_content
from tests.unit.orbyte.orbytebot.discord.conftest import AsyncIteratorMock
from tests.unit.orbyte.orbytebot.discord.conftest import mock_message
...
class TestContextFormatting:
    ...
    def test_context_format_bot_marker(self, mock_bot_user: MagicMock) -> None:
        """Bot messages in context are marked as OrbyteBot:."""
        msg = mock_message(
            content="Bot response",
            author_bot=True,
            author_id=mock_bot_user.id,
