...
from orbyte.orbytebot.slack.icons import _DEFAULT_SOURCE_IMAGE_FILENAME
from orbyte.orbytebot.slack.icons import _PUBLIC_SOURCE_IMAGE_BASE_URL
from orbyte.orbytebot.slack.icons import _SOURCE_IMAGE_FILENAMES
