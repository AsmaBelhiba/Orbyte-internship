...
def _run_adapter_build(
    ...
    from orbyte.indexing.adapters.user_file_indexing_adapter import (
    ...
    with (
        patch(
            "orbyte.indexing.adapters.user_file_indexing_adapter.fetch_user_project_ids_for_user_files",
            return_value=project_ids_map,
        ),
        patch(
            "orbyte.indexing.adapters.user_file_indexing_adapter.fetch_persona_ids_for_user_files",
            return_value=persona_ids_map,
        ),
        patch(
            "orbyte.indexing.adapters.user_file_indexing_adapter.get_access_for_user_files",
            return_value={file_id: _make_access()},
        ),
        patch(
            "orbyte.indexing.adapters.user_file_indexing_adapter.fetch_chunk_counts_for_user_files",
            return_value=[(file_id, 0)],
        ),
        patch(
            "orbyte.indexing.adapters.user_file_indexing_adapter.get_default_llm",
