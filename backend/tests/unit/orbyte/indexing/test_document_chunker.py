...
from orbyte.indexing.chunking import text_section_chunker as text_chunker_module
...
def test_file_backed_tabular_section_in_untitled_doc_is_chunked(
    ...
    import orbyte.indexing.chunking.tabular_section_chunker.tabular_section_chunker as tab_mod
