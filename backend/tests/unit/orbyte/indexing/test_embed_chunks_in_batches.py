...
from orbyte.indexing.indexing_pipeline import _embed_chunks_to_store
...
class TestEmbedChunksInBatches:
    @patch(
        "orbyte.indexing.indexing_pipeline.embed_chunks_with_failure_handling",
    )
    @patch("orbyte.indexing.indexing_pipeline.MAX_CHUNKS_PER_DOC_BATCH", 100)
    ...
    @patch("orbyte.indexing.indexing_pipeline.MAX_CHUNKS_PER_DOC_BATCH", 3)
