...
from orbyte.federated_connectors.oauth_utils import OAUTH_STATE_TTL
from orbyte.federated_connectors.oauth_utils import OAuthSession
...
def _patched(cache: _MemoryCacheBackend):
    return patch(
        "orbyte.federated_connectors.oauth_utils.get_cache_backend",
        return_value=cache,
    )
