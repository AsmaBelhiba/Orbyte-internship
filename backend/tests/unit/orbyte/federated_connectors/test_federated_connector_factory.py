...
from orbyte.federated_connectors.factory import _federated_connector_cache
from orbyte.federated_connectors.factory import _load_federated_connector_class
from orbyte.federated_connectors.factory import FederatedConnectorMissingException
...
from orbyte.federated_connectors.registry import FEDERATED_CONNECTOR_CLASS_MAP
from orbyte.federated_connectors.registry import FederatedConnectorMapping
...
class TestFederatedConnectorMappingValidation:
    ...
    def test_mapping_format_consistency(self) -> None:
        ...
        for source, mapping in FEDERATED_CONNECTOR_CLASS_MAP.items():
            ...
            assert mapping.module_path.startswith("orbyte.federated_connectors."), (
                f"{source.value} module_path doesn't start with orbyte.federated_connectors."
            )
...
class TestFederatedConnectorClassLoading:
    ...
    def test_load_federated_connector_class_import_error(
        ...
        assert (
            "Failed to import SlackFederatedConnector from orbyte.federated_connectors.slack.federated_connector"
