...
from orbyte.configs.chat_configs import SECONDARY_LLM_FLOW_TIMEOUT_S
from orbyte.configs.constants import DocumentSource
from orbyte.context.search.models import ContextExpansionType
...
from orbyte.llm.multi_llm import LLMTimeoutError
...
@patch("orbyte.secondary_llm_flows.document_filter.record_llm_response")
@patch(
    "orbyte.secondary_llm_flows.document_filter.llm_generation_span",
