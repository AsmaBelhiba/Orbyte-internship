...
from orbyte.secondary_llm_flows.time_filter import _parse_time_decision
from orbyte.secondary_llm_flows.time_filter import decide_time_filter
from orbyte.secondary_llm_flows.time_filter import DocumentTimeField
...
def _run_decision(
    ...
    with (
        patch(
            "orbyte.secondary_llm_flows.time_filter.llm_generation_span",
            return_value=nullcontext(MagicMock()),
        ),
        patch("orbyte.secondary_llm_flows.time_filter.record_llm_response"),
    ):
