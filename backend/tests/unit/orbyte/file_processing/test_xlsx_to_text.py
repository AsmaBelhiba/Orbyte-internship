...
from orbyte.file_processing.extract_file_text import _sheet_to_csv
from orbyte.file_processing.extract_file_text import xlsx_sheet_extraction
from orbyte.file_processing.extract_file_text import xlsx_to_text
...
class TestSheetToCsvStreaming:
    ...
    def test_cell_cap_truncates_and_appends_marker(self) -> None:
        ...
        with patch(
            "orbyte.file_processing.extract_file_text.MAX_XLSX_CELLS_PER_SHEET", 5
        ):
            csv_text = _sheet_to_csv(
                iter(
                    [
...
class TestXlsxSheetExtraction:
    ...
    def test_known_openpyxl_bug_max_value_returns_empty(self) -> None:
        ...
        with patch(
            "orbyte.file_processing.extract_file_text.openpyxl.load_workbook",
