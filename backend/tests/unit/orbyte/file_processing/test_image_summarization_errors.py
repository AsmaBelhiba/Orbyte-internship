...
class TestUnsupportedMimeTypeLogging:
    ...
    @patch(
        "orbyte.file_processing.image_summarization.summarize_image_pipeline",
        side_effect=__import__(
            "orbyte.file_processing.image_summarization",
    ...
    def test_logs_magic_bytes_and_size(
        ...
        with patch("orbyte.file_processing.image_summarization.logger") as mock_logger:
