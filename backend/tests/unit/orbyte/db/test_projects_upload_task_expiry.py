...
@patch("orbyte.db.projects.get_current_tenant_id", return_value="test_tenant")
@patch("orbyte.db.projects.create_user_files")
@patch(
    "orbyte.background.celery.versioned_apps.client.app",
