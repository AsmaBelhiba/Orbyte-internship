...
from orbyte.db.usage import get_current_window_start
from orbyte.db.usage import get_or_create_tenant_usage
from orbyte.db.usage import get_tenant_usage_stats
from orbyte.db.usage import increment_usage
from orbyte.db.usage import TenantUsageStats
...
class TestGetCurrentWindowStart:
    ...
    def test_weekly_window_aligns_to_monday(self) -> None:
        ...
        with patch("orbyte.db.usage.USAGE_LIMIT_WINDOW_SECONDS", 604800):  # 1 week
...
class TestCheckUsageLimit:
    ...
    def test_passes_when_under_limit(self) -> None:
        ...
        with patch("orbyte.db.usage.get_tenant_usage_stats", return_value=mock_stats):
            # Should not raise
            check_usage_limit(
                mock_session,
                UsageType.LLM_COST,
...
class TestWindowRollover:
    ...
    def test_new_window_resets_usage(self) -> None:
        ...
        with patch(
            "orbyte.db.usage.get_current_window_start",
