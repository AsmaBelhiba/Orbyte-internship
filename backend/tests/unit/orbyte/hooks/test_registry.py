...
from orbyte.hooks import registry as registry_module
from orbyte.hooks.registry import get_all_specs
from orbyte.hooks.registry import get_hook_point_spec
