...
import orbyte.configs.sentry as sentry_module
from orbyte.configs.sentry import _add_instance_tags
...
class TestAddInstanceTags:
    ...
    @patch("orbyte.utils.telemetry.get_or_generate_uuid", return_value="test-uuid-1234")
    ...
    @patch(
        "orbyte.utils.telemetry.get_or_generate_uuid",
