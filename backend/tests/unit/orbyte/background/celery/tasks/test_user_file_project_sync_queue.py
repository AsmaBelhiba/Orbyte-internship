...
@patch(
    "orbyte.background.celery.tasks.user_file_processing.tasks.get_user_file_project_sync_queue_depth"
)
@patch("orbyte.background.celery.tasks.user_file_processing.tasks.get_redis_client")
...
@patch(
    "orbyte.background.celery.tasks.user_file_processing.tasks.enqueue_user_file_project_sync_task"
)
@patch(
    "orbyte.background.celery.tasks.user_file_processing.tasks.get_user_file_project_sync_queue_depth"
)
@patch(
    "orbyte.background.celery.tasks.user_file_processing.tasks.get_session_with_current_tenant"
)
@patch("orbyte.background.celery.tasks.user_file_processing.tasks.get_redis_client")
