...
Covers `ee.orbyte.utils.tier.get_tier()` end-to-end against real Redis. The CP
...
from ee.orbyte.server.tenants.tier_management import TENANT_TIER_KEY
from ee.orbyte.server.tenants.tier_management import update_tenant_tier
from ee.orbyte.utils import tier as tier_module
