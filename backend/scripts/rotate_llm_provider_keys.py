...
Usage (docker):
    docker exec -it orbyte-api_server-1 \
...
from orbyte.db.models import CloudEmbeddingProvider  # noqa: E402
from orbyte.db.models import LLMProvider  # noqa: E402
from orbyte.db.models import VoiceProvider  # noqa: E402
