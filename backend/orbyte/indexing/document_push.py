...
- the EE DOCUMENT_PUSH hook (orbyte/hooks/points/document_push.py), managed via
...
from orbyte.configs.app_configs import DOCUMENT_PUSH_API_KEY
from orbyte.configs.app_configs import DOCUMENT_PUSH_ENDPOINT_URL
from orbyte.configs.app_configs import DOCUMENT_PUSH_TIMEOUT_SECONDS
from orbyte.utils.external_endpoint import ExternalEndpointConfig
from orbyte.utils.external_endpoint import post_json_to_endpoint
