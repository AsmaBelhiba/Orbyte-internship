...
from orbyte.configs.app_configs import EMAIL_ARCHIVE_BCC_ADDRESSES
from orbyte.configs.app_configs import EMAIL_CONFIGURED
from orbyte.configs.app_configs import EMAIL_FROM
from orbyte.configs.app_configs import SENDGRID_API_KEY
from orbyte.configs.app_configs import SMTP_PASS
from orbyte.configs.app_configs import SMTP_PORT
from orbyte.configs.app_configs import SMTP_SERVER
from orbyte.configs.app_configs import SMTP_STARTTLS
from orbyte.configs.app_configs import SMTP_USER
...
from orbyte.utils.url import add_url_params
...
def build_html_email(
    ...
    community_link_fragment = ""
    if application_name == ORBYTE_DEFAULT_APPLICATION_NAME:
        community_link_fragment = f'<br>Have questions? Join our Discord community <a href="{ORBYTE_DISCORD_URL}">here</a>.'
...
def send_subscription_cancellation_email(user_email: str) -> None:
    ...
    try:
        load_runtime_settings_fn = fetch_versioned_implementation(
            "orbyte.server.enterprise_settings.store", "load_runtime_settings"
        )
