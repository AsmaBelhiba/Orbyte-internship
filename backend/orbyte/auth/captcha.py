...
from orbyte.configs.app_configs import CAPTCHA_ENABLED
from orbyte.configs.app_configs import RECAPTCHA_ENTERPRISE_API_KEY
from orbyte.configs.app_configs import RECAPTCHA_ENTERPRISE_PROJECT_ID
from orbyte.configs.app_configs import RECAPTCHA_HOSTNAME_ALLOWLIST
from orbyte.configs.app_configs import RECAPTCHA_SCORE_THRESHOLD
from orbyte.configs.app_configs import RECAPTCHA_SITE_KEY
...
CAPTCHA_COOKIE_NAME = "orbyte_captcha_verified"
...
def _cookie_signing_key() -> bytes:
    return hashlib.sha256(
        f"orbyte-captcha-cookie-v1::{USER_AUTH_SECRET}".encode("utf-8")
    ).digest()
