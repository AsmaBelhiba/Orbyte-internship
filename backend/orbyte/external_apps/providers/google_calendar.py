from orbyte.configs.app_configs import EXT_APP_GOOGLE_CALENDAR_CLIENT_ID
from orbyte.configs.app_configs import EXT_APP_GOOGLE_CALENDAR_CLIENT_SECRET
...
from orbyte.external_apps.providers.google_base import GoogleOAuthProvider
...
class GoogleCalendarProvider(GoogleOAuthProvider, OrbyteManagedExtApp):
    spec = GoogleOAuthProvider.build_spec(
        ...
        description=(
            "Read and create events on your Google Calendar from inside Orbyte Craft."
        ),
