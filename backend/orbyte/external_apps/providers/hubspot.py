...
from orbyte.configs.app_configs import EXT_APP_HUBSPOT_CLIENT_ID
from orbyte.configs.app_configs import EXT_APP_HUBSPOT_CLIENT_SECRET
...
class HubspotProvider(OAuthExternalAppProvider, OrbyteManagedExtApp):
    spec = OAuthProviderSpec(
        ...
        descriptor=AdminDescriptorSpec(
            ...
            setup_instructions=(
                ...
                "On the app's Auth tab, add this Orbyte instance's callback URL "
