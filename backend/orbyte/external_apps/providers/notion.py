...
from orbyte.configs.app_configs import EXT_APP_NOTION_CLIENT_ID
from orbyte.configs.app_configs import EXT_APP_NOTION_CLIENT_SECRET
...
from orbyte.external_apps.providers.base import TokenExchangeRequest
...
class NotionProvider(OAuthExternalAppProvider, OrbyteManagedExtApp):
    spec = OAuthProviderSpec(
        ...
        descriptor=AdminDescriptorSpec(
            ...
            setup_instructions=(
                ...
                "type to Public. Under OAuth Domain & URIs, add this Orbyte "
