...
from orbyte.configs.app_configs import EXT_APP_GMAIL_CLIENT_ID
from orbyte.configs.app_configs import EXT_APP_GMAIL_CLIENT_SECRET
...
class GmailProvider(GoogleOAuthProvider, OrbyteManagedExtApp):
