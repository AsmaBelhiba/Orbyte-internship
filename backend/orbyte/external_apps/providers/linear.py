...
from orbyte.configs.app_configs import EXT_APP_LINEAR_CLIENT_ID
from orbyte.configs.app_configs import EXT_APP_LINEAR_CLIENT_SECRET
...
class LinearProvider(OAuthExternalAppProvider, OrbyteManagedExtApp):
    spec = OAuthProviderSpec(
        ...
        descriptor=AdminDescriptorSpec(
            ...
            setup_instructions=(
                ...
                "Add this Orbyte instance's callback URL "
