from orbyte.configs.app_configs import EXT_APP_GOOGLE_DRIVE_CLIENT_ID
from orbyte.configs.app_configs import EXT_APP_GOOGLE_DRIVE_CLIENT_SECRET
...
class GoogleDriveProvider(GoogleOAuthProvider, OrbyteManagedExtApp):
    spec = GoogleOAuthProvider.build_spec(
        ...
        description=(
            ...
            "Google Drive inside Orbyte Craft."
        ),
