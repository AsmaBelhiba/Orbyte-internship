...
from orbyte.configs.app_configs import EXT_APP_SLACK_CLIENT_ID
from orbyte.configs.app_configs import EXT_APP_SLACK_CLIENT_SECRET
...
class SlackProvider(OAuthExternalAppProvider, OrbyteManagedExtApp):
    spec = OAuthProviderSpec(
        ...
        descriptor=AdminDescriptorSpec(
            description=(
                "Read your Slack messages and channels as context inside Orbyte Craft."
            ),
            ...
            setup_instructions=(
                ...
                "Permissions, add this Orbyte instance's callback URL "
