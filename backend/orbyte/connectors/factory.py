...
from orbyte.connectors.credentials_provider import OrbyteDBCredentialsProvider
...
from orbyte.connectors.interfaces import EventConnector
...
from orbyte.db.credentials import backend_update_credential_json
from orbyte.db.credentials import fetch_credential_by_id
...
from orbyte.utils.credential_audit import emit_credential_access
...
def instantiate_connector(
    ...
    if isinstance(connector, CredentialsConnector):
        ...
        if credential.credential_json:
            # Distinct decrypt site from OrbyteDBCredentialsProvider (static /
