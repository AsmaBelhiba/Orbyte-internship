...
from orbyte.configs.app_configs import SHAREPOINT_CONNECTOR_SIZE_THRESHOLD
...
from orbyte.connectors.interfaces import IndexingHeartbeatInterface
...
from orbyte.connectors.microsoft_graph_env import resolve_microsoft_environment
...
from orbyte.connectors.models import ExternalAccess
...
from orbyte.connectors.sharepoint.connector_utils import get_sharepoint_external_access
...
from orbyte.utils.url import validate_outbound_http_url
...
def _convert_driveitem_to_document_with_permissions(
    ...
    if not mime_type or mime_type in OrbyteMimeTypes.EXCLUDED_IMAGE_TYPES:
        logger.debug(
    ...
    elif file_ext in OrbyteFileExtensions.IMAGE_EXTENSIONS:
...
class SharepointConnector(
    ...
    def _process_drive_item(
        ...
        if driveitem_extension not in OrbyteFileExtensions.ALL_ALLOWED_EXTENSIONS:
            logger.warning(
        ...
        should_yield_if_empty = (
            driveitem_extension in OrbyteFileExtensions.IMAGE_EXTENSIONS
