...
from orbyte.connectors.google_utils.shared_constants import GOOGLE_SCOPES
from orbyte.connectors.google_utils.shared_constants import (
...
from orbyte.db.credentials import update_credential_json
...
def update_credential_access_tokens(
    ...
    try:
        ...
        if MISSING_SCOPES_ERROR_STR in str(e):
            raise OrbyteError(
                OrbyteErrorCode.INSUFFICIENT_PERMISSIONS, ORBYTE_SCOPE_INSTRUCTIONS
            ) from e
        raise e
