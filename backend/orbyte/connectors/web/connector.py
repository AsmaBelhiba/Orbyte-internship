...
from orbyte.server.security.models import web_connector_ssrf_enforced
...
# patch these names on `orbyte.connectors.web.connector`.
from orbyte.utils.playwright_fetch import DEFAULT_HEADERS
from orbyte.utils.playwright_fetch import DEFAULT_USER_AGENT  # noqa: F401
from orbyte.utils.playwright_fetch import start_playwright
from orbyte.utils.sitemap import list_pages_for_site
        ...
        try:
            ...
            if not slim and self.scroll_before_scraping:
                try:
                    ...
                    # (ORBYTE-BACKEND-H6G5). Skip auto-scroll in that case and
