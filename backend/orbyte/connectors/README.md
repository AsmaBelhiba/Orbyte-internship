<!-- ORBYTE_METADATA={"link": "https://github.com/onyx-dot-app/onyx/blob/main/backend/onyx/connectors/README.md"} -->

# Writing a new Orbyte Connector

This README covers how to contribute a new Connector for Orbyte. It includes an overview of the design, interfaces,
...
> Note: Be sure to set PYTHONPATH to orbyte/backend before running the above main.
