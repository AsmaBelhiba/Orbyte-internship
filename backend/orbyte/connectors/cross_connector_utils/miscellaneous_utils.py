...
from orbyte.configs.app_configs import CONNECTOR_LOCALHOST_OVERRIDE
from orbyte.configs.constants import DocumentSource
from orbyte.configs.constants import IGNORE_FOR_QA
from orbyte.connectors.models import BasicExpertInfo
from orbyte.connectors.models import OrbyteMetadata
from orbyte.utils.datetime import datetime_to_utc
from orbyte.utils.logger import setup_logger
from orbyte.utils.text_processing import is_valid_email
...
def process_orbyte_metadata(
    metadata: dict[str, Any],
) -> tuple[OrbyteMetadata, dict[str, Any]]:
    """
    Users may set Orbyte metadata and custom tags in text files. https://docs.onyx.app/admins/connectors/official/file
