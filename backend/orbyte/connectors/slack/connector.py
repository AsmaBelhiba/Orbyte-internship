...
from orbyte.configs.app_configs import ENABLE_EXPENSIVE_EXPERT_CALLS
from orbyte.configs.app_configs import INDEX_BATCH_SIZE
from orbyte.configs.app_configs import SLACK_NUM_THREADS
...
from orbyte.connectors.interfaces import CredentialsConnector
from orbyte.connectors.interfaces import CredentialsProviderInterface
...
from orbyte.connectors.slack.access import get_channel_access
from orbyte.connectors.slack.models import ChannelType
from orbyte.connectors.slack.models import MessageType
from orbyte.connectors.slack.models import ThreadType
from orbyte.connectors.slack.orbyte_retry_handler import OrbyteRedisSlackRetryHandler
from orbyte.connectors.slack.orbyte_slack_web_client import OrbyteSlackWebClient
from orbyte.connectors.slack.utils import expert_info_from_slack_id
from orbyte.connectors.slack.utils import fetch_team_user_emails
from orbyte.connectors.slack.utils import get_message_link
from orbyte.connectors.slack.utils import make_paginated_slack_api_call
...
from orbyte.utils.retry_after import parse_retry_after_seconds
...
class SlackConnector(
    ...
    def make_slack_web_client(
        ...
        # for concurrent workers. We've extended it with OrbyteRedisSlackRetryHandler.
        ...
        orbyte_rate_limit_error_retry_handler = OrbyteRedisSlackRetryHandler(
            max_retry_count=max_retry_count,
            delay_key=delay_key,
            r=r,
        )
        custom_retry_handlers: list[RetryHandler] = [
            ...
            orbyte_rate_limit_error_retry_handler,
        ]

        client = OrbyteSlackWebClient(
...
if __name__ == "__main__":
    ...
    provider = OrbyteStaticCredentialsProvider(
