...
from orbyte.configs.app_configs import DRUPAL_WIKI_ATTACHMENT_SIZE_THRESHOLD
...
from orbyte.connectors.drupal_wiki.models import DrupalWikiCheckpoint
from orbyte.connectors.drupal_wiki.models import DrupalWikiPage
from orbyte.connectors.drupal_wiki.models import DrupalWikiPageResponse
from orbyte.connectors.drupal_wiki.models import DrupalWikiSpaceResponse
from orbyte.connectors.drupal_wiki.utils import build_drupal_wiki_document_id
...
class DrupalWikiConnector(
        ...
        **kwargs: Any,
        ...
        if deprecated_found:
            raise ConnectorValidationError(
                ...
                f"Please delete and recreate this connector, or contact Orbyte support "
    ...
    def _validate_attachment_filetype(self, attachment: dict[str, Any]) -> bool:
        ...
        if file_extension in OrbyteFileExtensions.ALL_ALLOWED_EXTENSIONS:
            return True
