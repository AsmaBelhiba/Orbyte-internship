...
_STATUS_TO_ERROR_CODE: dict[int, OrbyteErrorCode] = {
    401: OrbyteErrorCode.CREDENTIAL_EXPIRED,
    403: OrbyteErrorCode.INSUFFICIENT_PERMISSIONS,
    404: OrbyteErrorCode.BAD_GATEWAY,
}


def _error_code_for_status(status_code: int) -> OrbyteErrorCode:
    """Map an HTTP status code to the appropriate OrbyteErrorCode.
    ...
    return OrbyteErrorCode.BAD_GATEWAY
