...
from orbyte.configs.app_configs import CONFLUENCE_CONNECTOR_USER_PROFILES_OVERRIDE
from orbyte.configs.app_configs import OAUTH_CONFLUENCE_CLOUD_CLIENT_ID
from orbyte.configs.app_configs import OAUTH_CONFLUENCE_CLOUD_CLIENT_SECRET
from orbyte.connectors.confluence.models import ConfluenceUser
from orbyte.connectors.confluence.user_profile_override import (
    process_confluence_user_profiles_override,
)
from orbyte.connectors.confluence.utils import _handle_http_error
from orbyte.connectors.confluence.utils import confluence_refresh_tokens
from orbyte.connectors.confluence.utils import get_start_param_from_url
from orbyte.connectors.confluence.utils import update_param_in_path
from orbyte.connectors.cross_connector_utils.miscellaneous_utils import scoped_url
...
from orbyte.file_processing.html_utils import format_document_soup
...
class OrbyteConfluence:
    ...
    def get_server_version(self) -> tuple[int, int] | None:
        ...
        Probed once per OrbyteConfluence instance via Atlassian's
...
def get_user_email_from_username__server(
    confluence_client: OrbyteConfluence, user_name: str
) -> str | None:
...
def get_user_email_from_userkey__server(
    confluence_client: OrbyteConfluence, user_key: str
) -> str | None:
...
def _get_user(confluence_client: OrbyteConfluence, user_id: str) -> str:
