...
from orbyte.configs.app_configs import CONFLUENCE_CONNECTOR_LABELS_TO_SKIP
from orbyte.configs.app_configs import CONFLUENCE_TIMEZONE_OFFSET
...
from orbyte.connectors.confluence.access import get_all_space_permissions
from orbyte.connectors.confluence.access import get_page_restrictions
from orbyte.connectors.confluence.access import (
...
from orbyte.connectors.confluence.utils import datetime_from_string
from orbyte.connectors.confluence.utils import update_param_in_path
from orbyte.connectors.confluence.utils import validate_attachment_filetype
...
from orbyte.connectors.interfaces import ConnectorFailure
...
class ConfluenceConnector(
    ...
    def __init__(
        ...
        self._confluence_client: OrbyteConfluence | None = None
        self._low_timeout_confluence_client: OrbyteConfluence | None = None
    ...
    @property
    def confluence_client(self) -> OrbyteConfluence:
        if self._confluence_client is None:
            raise ConnectorMissingCredentialError("Confluence")
        return self._confluence_client

    @property
    def low_timeout_confluence_client(self) -> OrbyteConfluence:
    ...
    def set_credentials_provider(
        ...
        confluence_client = OrbyteConfluence(
        ...
        low_timeout_confluence_client = OrbyteConfluence(
            is_cloud=self.is_cloud,
            url=self.wiki_base,
            credentials_provider=credentials_provider,
            timeout=3,
