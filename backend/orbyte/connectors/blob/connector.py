...
from orbyte.configs.app_configs import BLOB_STORAGE_SIZE_THRESHOLD
            ...
            if authentication_method == "access_key":
                ...
                def _refresh_credentials() -> dict[str, str]:
                    ...
                    assumed_role_object = sts_client.assume_role(
                        RoleArn=role_arn,
                        RoleSessionName=f"orbyte_blob_storage_{int(time.time())}",
                    )
    ...
    def _yield_blob_objects(
        ...
        for page in pages:
            ...
            for obj in page["Contents"]:
                ...
                # Handle image files
                if file_ext in OrbyteFileExtensions.IMAGE_EXTENSIONS:
                ...
                try:
                    ...
                    orbyte_metadata, custom_tags = process_orbyte_metadata(
                        extraction_result.metadata
                    )
                    file_display_name = orbyte_metadata.file_display_name or file_name
                    time_updated = orbyte_metadata.doc_updated_at or last_modified
                    ...
                    source_type = orbyte_metadata.source_type or DocumentSource(
