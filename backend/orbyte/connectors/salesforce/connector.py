...
from orbyte.connectors.salesforce.doc_conversion import convert_sf_object_to_doc
from orbyte.connectors.salesforce.doc_conversion import convert_sf_query_result_to_doc
...
from orbyte.connectors.salesforce.salesforce_calls import fetch_all_csvs_in_parallel
...
from orbyte.connectors.salesforce.utils import CREATED_FIELD
from orbyte.connectors.salesforce.utils import ID_FIELD
from orbyte.connectors.salesforce.utils import MODIFIED_FIELD
from orbyte.connectors.salesforce.utils import NAME_FIELD
...
class SalesforceConnector(LoadConnector, PollConnector, SlimConnectorWithPermSync):
    ...
    def __init__(
        ...
        self._sf_client: OrbyteSalesforce | None = None
    ...
    def load_credentials(
        ...
        self._sf_client = OrbyteSalesforce(
    ...
    @property
    def sf_client(self) -> OrbyteSalesforce:
    ...
    def _load_csvs_to_db(
        csv_directory: str, remove_ids: bool, sf_db: OrbyteSalesforceSQLite
    ) -> dict[str, str]:
        """
        ...
        # from import orbyte.connectors.salesforce.sf_db.sqlite_functions find_ids_by_type
    ...
    #     parent_types: list[str], sf_client: OrbyteSalesforce
    # ) -> set[str]:
    ...
    def _full_sync(
        ...
        sf_db = OrbyteSalesforceSQLite(os.path.join(temp_dir, "salesforce_db.sqlite"))
        sf_db.connect()
    ...
    def _make_context(
        ...
        for parent_type in parent_types:
            # parent_orbyte_sf_type = OrbyteSalesforceType(parent_type, sf_client)
        ...
        for sf_type in all_types:
            # orbyte_sf_type = OrbyteSalesforceType(sf_type, sf_client)
