...
from orbyte.connectors.salesforce.utils import remove_sqlite_db_files
from orbyte.connectors.salesforce.utils import SalesforceObject
from orbyte.connectors.salesforce.utils import USER_OBJECT_TYPE
from orbyte.connectors.salesforce.utils import validate_salesforce_id
    ...
    def _apply_schema_impl(self) -> None:
        ...
        with self._conn:
            ...
            if cursor.fetchone()[0] == 0:
                OrbyteSalesforceSQLite._update_user_email_map(cursor)
            elapsed = time.monotonic() - start
            logger.info(
            ...
            with open(csv_download_path, "r", newline="", encoding="utf-8") as f:
                ...
                for row in reader:
                    ...
                    normalized_record, parent_ids = (
                        OrbyteSalesforceSQLite.normalize_record(row, remove_ids)
                    )
                    ...
                    OrbyteSalesforceSQLite._update_relationship_tables(
