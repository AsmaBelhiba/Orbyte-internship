...
class OrbyteDBCredentialsProvider(
    CredentialsProviderInterface["OrbyteDBCredentialsProvider"]
):
    ...
    def __enter__(self) -> "OrbyteDBCredentialsProvider":
...
class OrbyteStaticCredentialsProvider(
    CredentialsProviderInterface["OrbyteStaticCredentialsProvider"]
):
    ...
    def __enter__(self) -> "OrbyteStaticCredentialsProvider":
        return self
