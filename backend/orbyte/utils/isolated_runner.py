...
Run as ``python -m orbyte.utils.isolated_runner`` so it works even when the caller is
...
def main() -> None:
    ...
    from orbyte.utils.process_isolation import STATUS_EXC
    from orbyte.utils.process_isolation import STATUS_OK
    from orbyte.utils.process_isolation import STATUS_UNRELAYABLE
