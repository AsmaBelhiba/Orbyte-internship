...
from orbyte.configs.app_configs import API_SERVER_HOST
from orbyte.configs.app_configs import API_SERVER_PROTOCOL
from orbyte.configs.app_configs import API_SERVER_URL_OVERRIDE_FOR_HTTP_REQUESTS
...
def fetch_versioned_implementation(module: str, attribute: str) -> Any:
    ...
    try:
        ...
        if is_ee:
            if "ee.orbyte" not in str(e):
                # If it's a non Orbyte related import failure, this is likely because
