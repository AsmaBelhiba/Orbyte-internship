...
def optional_telemetry(
    ...
    try:
        ...
        # Should never interfere with normal functions of Orbyte
        pass
...
def mt_cloud_telemetry(
    ...
    # This is only for Orbyte MT Cloud, this code should also never be hit, no reason for any orgs to
    # be running the Multi Tenant version of Orbyte.
    fetch_versioned_implementation_with_fallback(
        module="orbyte.utils.telemetry",
...
def _get_tenant_id_for_user_identify(user_email: str) -> str | None:
    try:
        return fetch_versioned_implementation_with_fallback(
            module="orbyte.server.tenants.user_mapping",
