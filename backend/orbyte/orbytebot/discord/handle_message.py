...
from orbyte.db.discord_bot import get_channel_config_by_discord_ids
...
from orbyte.db.models import DiscordChannelConfig
from orbyte.db.models import DiscordGuildConfig
from orbyte.orbytebot.discord.api_client import OrbyteAPIClient
from orbyte.orbytebot.discord.constants import MAX_CONTEXT_MESSAGES
from orbyte.orbytebot.discord.constants import MAX_MESSAGE_LENGTH
from orbyte.orbytebot.discord.constants import THINKING_EMOJI
from orbyte.orbytebot.discord.exceptions import APIError
...
def _format_messages_as_context(
    ...
    return (
        "You are a Discord bot named OrbyteBot.\n"
...
async def send_response(
    ...
    if isinstance(message.channel, discord.Thread):
        ...
        thread_name = f"OrbyteBot <> {message.author.display_name}"[:100]
...
async def send_error_response(
    ...
    error_msg = "Sorry, I encountered an error processing your message. You may want to contact Orbyte for support :sweat_smile:"
