...
from orbyte.orbytebot.discord.constants import CACHE_REFRESH_INTERVAL
...
from orbyte.orbytebot.discord.handle_message import should_respond
from orbyte.orbytebot.discord.utils import get_bot_token
from orbyte.utils.logger import setup_logger

logger = setup_logger()


class OrbyteDiscordClient(commands.Bot):
    ...
    def __init__(self, command_prefix: str = DISCORD_BOT_INVOKE_CHAR) -> None:
        ...
        self.api_client = OrbyteAPIClient()
...
def main() -> None:
    ...
    logger.info("Starting Orbyte Discord Bot...")
