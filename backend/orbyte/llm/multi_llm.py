...
from orbyte.configs.app_configs import MOCK_LLM_RESPONSE
from orbyte.configs.app_configs import SEND_USER_METADATA_TO_LLM_PROVIDER
from orbyte.configs.chat_configs import LLM_FIRST_CHUNK_MAX_RETRIES
from orbyte.configs.chat_configs import LLM_SOCKET_READ_TIMEOUT
from orbyte.configs.model_configs import GEN_AI_TEMPERATURE
from orbyte.configs.model_configs import LITELLM_EXTRA_BODY
from orbyte.llm.constants import LlmProviderNames
from orbyte.llm.cost import calculate_llm_cost_cents
...
from orbyte.llm.models import ANTHROPIC_ADAPTIVE_REASONING_EFFORT
from orbyte.llm.models import ANTHROPIC_REASONING_EFFORT_BUDGET
from orbyte.llm.models import OPENAI_REASONING_EFFORT
from orbyte.llm.request_context import get_llm_mock_response
from orbyte.llm.utils import build_litellm_passthrough_kwargs
from orbyte.llm.well_known_providers.constants import AWS_ACCESS_KEY_ID_KWARG
...
from orbyte.utils.encryption import mask_env_value_for_logging
...
class LitellmLLM(LLM):
    ...
    def _track_llm_cost(self, usage: Usage) -> None:
        """
        Track LLM usage cost for Orbyte-managed API keys.
        ...
        2. The API key is one of Orbyte's managed default keys
        """
        ...
        from orbyte.server.usage_limits import is_orbyte_managed_api_key

        if not is_orbyte_managed_api_key(self._api_key):
            return
    ...
    def invoke(
        ...
        from orbyte.llm.model_response import from_litellm_model_response
        ...
        try:
            ...
            # Track LLM cost for Orbyte-managed API keys
    ...
    def stream(
        ...
        from orbyte.llm.model_response import from_litellm_model_response_stream
