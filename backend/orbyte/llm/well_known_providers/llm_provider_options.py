...
from orbyte.llm.model_capabilities import get_max_input_tokens
from orbyte.llm.utils import model_supports_image_input
...
from orbyte.llm.well_known_providers.constants import BEDROCK_PROVIDER_NAME
from orbyte.llm.well_known_providers.constants import BIFROST_PROVIDER_NAME
from orbyte.llm.well_known_providers.constants import LITELLM_PROXY_PROVIDER_NAME
from orbyte.llm.well_known_providers.constants import LM_STUDIO_PROVIDER_NAME
from orbyte.llm.well_known_providers.constants import NEBIUS_TOKENFACTORY_PROVIDER_NAME
from orbyte.llm.well_known_providers.constants import OLLAMA_PROVIDER_NAME
from orbyte.llm.well_known_providers.constants import OPENAI_COMPATIBLE_PROVIDER_NAME
...
from orbyte.llm.well_known_providers.models import WellKnownLLMProviderDescriptor
...
def get_provider_display_name(provider_name: str) -> str:
    """Get human-friendly display name for an Orbyte-supported provider.

    First checks Orbyte-specific display names, then falls back to
    PROVIDER_DISPLAY_NAMES from constants.
    """
    # Display names for Orbyte-supported LLM providers (used in admin UI provider selection).
    # These override PROVIDER_DISPLAY_NAMES for Orbyte-specific branding.
    _ORBYTE_PROVIDER_DISPLAY_NAMES: dict[str, str] = {
    ...
    if provider_name in _ORBYTE_PROVIDER_DISPLAY_NAMES:
        return _ORBYTE_PROVIDER_DISPLAY_NAMES[provider_name]
