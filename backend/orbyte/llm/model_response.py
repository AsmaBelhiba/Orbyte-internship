...
def from_litellm_model_response_stream(
    ...
    """
    Convert a LiteLLM ModelResponseStream into the simplified Orbyte representation.
    """
...
def from_litellm_model_response(
    ...
    """
    Convert a LiteLLM ModelResponse into the simplified Orbyte representation.
    """
    response_data = response.model_dump()
