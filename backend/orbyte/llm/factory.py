...
from orbyte.llm.utils import get_max_input_tokens_from_llm_provider
...
from orbyte.utils.headers import build_llm_extra_headers
...
def _build_provider_extra_headers(
    ...
    # Passing these will put Orbyte on the OpenRouter leaderboard
