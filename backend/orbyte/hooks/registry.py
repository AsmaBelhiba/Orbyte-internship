...
from orbyte.hooks.points.base import HookPointSpec
from orbyte.hooks.points.document_ingestion import DocumentIngestionSpec
from orbyte.hooks.points.document_push import DocumentPushSpec
from orbyte.hooks.points.query_processing import QueryProcessingSpec
...
def validate_registry() -> None:
    ...
    if missing:
        raise RuntimeError(
            ...
            "Add an entry to orbyte.hooks.registry._REGISTRY."
        )
