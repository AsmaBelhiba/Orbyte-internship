...
Usage in a worker app module:
    from orbyte.server.metrics.indexing_task_metrics import (
...
from orbyte.server.metrics.celery_task_metrics import _MAX_START_TIME_AGE_SECONDS
...
_INDEXING_TASK_NAMES: frozenset[str] = frozenset(
    {
        OrbyteCeleryTask.CONNECTOR_DOC_FETCHING_TASK,
...
INDEXING_TASK_DURATION = Histogram(
    "orbyte_indexing_task_duration_seconds",
