...
Usage:
    from orbyte.server.metrics.pruning_metrics import (
...
PRUNING_ENUMERATION_DURATION = Histogram(
    "orbyte_pruning_enumeration_duration_seconds",
...
PRUNING_DIFF_DURATION = Histogram(
    "orbyte_pruning_diff_duration_seconds",
...
PRUNING_RATE_LIMIT_ERRORS = Counter(
    "orbyte_pruning_rate_limit_errors_total",
