...
_QUEUE_LABEL_MAP: dict[str, str] = {
    OrbyteCeleryQueues.PRIMARY: "primary",
    OrbyteCeleryQueues.DOCPROCESSING: "docprocessing",
    OrbyteCeleryQueues.CONNECTOR_DOC_FETCHING: "docfetching",
    OrbyteCeleryQueues.VESPA_METADATA_SYNC: "vespa_metadata_sync",
    OrbyteCeleryQueues.CONNECTOR_DELETION: "connector_deletion",
    OrbyteCeleryQueues.CONNECTOR_PRUNING: "connector_pruning",
    OrbyteCeleryQueues.CONNECTOR_DOC_PERMISSIONS_SYNC: "permissions_sync",
    OrbyteCeleryQueues.CONNECTOR_EXTERNAL_GROUP_SYNC: "external_group_sync",
    OrbyteCeleryQueues.DOC_PERMISSIONS_UPSERT: "permissions_upsert",
    OrbyteCeleryQueues.CONNECTOR_HIERARCHY_FETCHING: "hierarchy_fetching",
    OrbyteCeleryQueues.LLM_MODEL_UPDATE: "llm_model_update",
    OrbyteCeleryQueues.CHECKPOINT_CLEANUP: "checkpoint_cleanup",
    OrbyteCeleryQueues.INDEX_ATTEMPT_CLEANUP: "index_attempt_cleanup",
    OrbyteCeleryQueues.CSV_GENERATION: "csv_generation",
    OrbyteCeleryQueues.USER_FILE_PROCESSING: "user_file_processing",
    OrbyteCeleryQueues.USER_FILE_PROJECT_SYNC: "user_file_project_sync",
    OrbyteCeleryQueues.USER_FILE_DELETE: "user_file_delete",
    OrbyteCeleryQueues.MONITORING: "monitoring",
    OrbyteCeleryQueues.SANDBOX: "sandbox",
    OrbyteCeleryQueues.OPENSEARCH_MIGRATION: "opensearch_migration",
}

# Queues where prefetched (unacked) task counts are meaningful
_UNACKED_QUEUES: list[str] = [
    OrbyteCeleryQueues.CONNECTOR_DOC_FETCHING,
    OrbyteCeleryQueues.DOCPROCESSING,
]
...
class WorkerHealthCollector(_CachedCollector):
    ...
    def _collect_fresh(self) -> list[GaugeMetricFamily]:
        ...
        active_workers = GaugeMetricFamily(
            "orbyte_celery_active_worker_count",
