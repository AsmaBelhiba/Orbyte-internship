...
from orbyte.configs.app_configs import DISABLE_METRICS_AUTH
from orbyte.configs.app_configs import METRICS_AUTH_TOKEN
...
def verify_metrics_token(request: Request) -> None:
    ...
    and any missing/invalid token raises ``OrbyteError(UNAUTHENTICATED)``. The token
