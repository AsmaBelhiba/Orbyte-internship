...
correct value across instances, e.g.:
    max by (cc_pair_id, connector_name) (orbyte_connector_in_error_state)
...
INDEX_ATTEMPT_STATUS = Counter(
    "orbyte_index_attempt_transitions_total",
