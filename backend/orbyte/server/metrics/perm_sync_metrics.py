...
DOC_PERM_SYNC_DURATION = Histogram(
    "orbyte_doc_perm_sync_duration_seconds",
...
DOC_PERM_SYNC_DB_UPDATE_DURATION = Histogram(
    "orbyte_doc_perm_sync_db_update_duration_seconds",
...
GROUP_SYNC_DURATION = Histogram(
    "orbyte_group_sync_duration_seconds",
...
GROUP_SYNC_UPSERT_DURATION = Histogram(
    "orbyte_group_sync_upsert_duration_seconds",
