"""Prometheus metrics setup for the Orbyte API server.
...
from orbyte.server.metrics.postgres_connection_pool import pool_timeout_handler
...
def setup_prometheus_metrics(app: Starlette) -> None:
    """Initialize HTTP request metrics for the Orbyte API server.
