"""Orbyte's internal sandbox-event schema.

Single import point for the typed events Orbyte's sandbox layer emits and
...
# Orbyte-synthesized ``Error.code`` sentinels for turn-terminating failures.
