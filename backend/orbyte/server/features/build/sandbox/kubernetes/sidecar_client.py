...
from orbyte.server.features.build.configs import SANDBOX_PUSH_PRIVATE_KEY
...
def get_push_key_pair() -> tuple[Ed25519PrivateKey, str]:
    ...
    if not SANDBOX_PUSH_PRIVATE_KEY:
        raise RuntimeError("ORBYTE_SANDBOX_PUSH_PRIVATE_KEY is not set")
    ...
    try:
        ...
        raise RuntimeError(
            "ORBYTE_SANDBOX_PUSH_PRIVATE_KEY is not a valid base64-encoded "
