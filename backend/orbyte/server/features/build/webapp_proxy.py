...
from orbyte.auth.users import is_same_origin
...
from orbyte.server.features.build.db.build_session import get_webapp_access_async
from orbyte.server.features.build.db.build_session import get_webapp_target_async
...
# prevent LLM-generated apps from setting cookies on the parent Orbyte domain.
EXCLUDED_HEADERS = {
    "content-encoding",
    "content-length",
    "transfer-encoding",
...
# LLM-generated webapp code and must never receive the viewer's Orbyte
...
async def _proxy_request(
    ...
    forwarded_headers = {
        ...
        if not (
            ...
            or lowered.startswith("x-orbyte-")
