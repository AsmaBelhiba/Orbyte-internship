...
Custom Orbyte packet types layered on top of the sandbox-event schema
(:mod:`sandbox.event_schema`). Sandbox events pass through directly from
the agent; this module only contains Orbyte-specific extensions like
...
Custom Orbyte packets (defined here):
- error: Orbyte-specific errors (e.g., session not found)
...
class BasePacket(BaseModel):
    """Base packet with common fields for all custom Orbyte packet types."""
...
# =============================================================================
# Custom Orbyte Packets
# =============================================================================


class ErrorPacket(BasePacket):
    """An Orbyte-specific error occurred (e.g., session not found, sandbox not running)."""
...
# =============================================================================
# Union Type for Custom Orbyte Packets
# =============================================================================
