...
SANDBOX_NAMESPACE = os.environ.get("SANDBOX_NAMESPACE", "orbyte-sandboxes")
...
SANDBOX_PUSH_PRIVATE_KEY = os.environ.get("ORBYTE_SANDBOX_PUSH_PRIVATE_KEY", "")
...
BUILD_MODE_NOT_CONFIGURED_API_KEY = "orbyte-provider-not-configured"
...
# mounts).
SANDBOX_PROXY_NAMESPACE = os.environ.get("SANDBOX_PROXY_NAMESPACE", "orbyte")
...
# Non-empty sentinel for every proxy-injected credential (ORBYTE_PAT + each
