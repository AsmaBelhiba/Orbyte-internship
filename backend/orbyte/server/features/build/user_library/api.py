...
from orbyte.server.features.build.configs import USER_LIBRARY_MAX_FILE_SIZE_BYTES
from orbyte.server.features.build.configs import USER_LIBRARY_MAX_FILES_PER_UPLOAD
from orbyte.server.features.build.configs import USER_LIBRARY_MAX_TOTAL_SIZE_BYTES
from orbyte.server.features.build.db.user_library import cleanup_old_blobs
...
from orbyte.server.features.build.db.user_library import get_user_storage_bytes
...
async def upload_zip(
    ...
    try:
        ...
        raise OrbyteError(OrbyteErrorCode.INVALID_INPUT, "Invalid zip file")
