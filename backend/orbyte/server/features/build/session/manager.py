...
from orbyte.server.features.build.configs import MAX_TOTAL_UPLOAD_SIZE_BYTES
...
from orbyte.server.features.build.db.build_session import get_empty_session_for_user
from orbyte.server.features.build.db.build_session import get_session_messages
...
from orbyte.server.features.build.db.sandbox import get_snapshots_for_session
from orbyte.server.features.build.db.sandbox import update_sandbox_heartbeat
from orbyte.server.features.build.rate_limit import get_user_rate_limit_status
...
from orbyte.server.features.build.session import streaming as _streaming
...
class SessionManager:
    ...
    def build_llm_configs(
        ...
        Raises:
            OrbyteError: If no accessible supported provider is configured.
        """
    ...
    def get_or_create_empty_session(
        ...
        if existing:
            ...
            # sandbox-global implementation data, so this removes the Orbyte
