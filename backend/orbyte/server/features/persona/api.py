...
from orbyte.auth.users import current_limited_user
...
from orbyte.db.persona import create_assistant_label
from orbyte.db.persona import create_update_persona
from orbyte.db.persona import delete_persona_label
from orbyte.db.persona import get_assistant_labels
from orbyte.db.persona import get_minimal_persona_snapshots_for_user
from orbyte.db.persona import get_minimal_persona_snapshots_paginated
from orbyte.db.persona import get_persona_by_id
from orbyte.db.persona import get_persona_count_for_user
from orbyte.db.persona import get_persona_snapshots_for_user
from orbyte.db.persona import get_persona_snapshots_paginated
...
from orbyte.db.persona import update_persona_featured
from orbyte.db.persona import update_persona_label
from orbyte.db.persona import update_persona_public_status
from orbyte.db.persona import update_persona_shared
from orbyte.db.persona import update_persona_visibility
from orbyte.db.persona import update_personas_display_priority
from orbyte.db.persona_sharing import get_persona_access_level
from orbyte.db.persona_sharing import get_user_group_ids_for_user
from orbyte.db.persona_sharing import persona_ownership_is_vacant
from orbyte.db.users import get_active_admin_count
...
from orbyte.server.features.persona.constants import ADMIN_AGENTS_RESOURCE
from orbyte.server.features.persona.constants import AGENTS_RESOURCE
from orbyte.server.features.persona.models import FullPersonaSnapshot
from orbyte.server.features.persona.models import MinimalPersonaSnapshot
from orbyte.server.features.persona.models import PersonaLabelCreate
from orbyte.server.features.persona.models import PersonaLabelResponse
...
from orbyte.server.manage.llm.api import get_valid_model_configuration_ids_for_persona
from orbyte.server.models import DisplayPriorityRequest
...
def transfer_persona_ownership_endpoint(
    ...
    versioned_transfer = fetch_versioned_implementation(
        "orbyte.db.persona", "transfer_persona_ownership"
    )
    try:
        versioned_transfer(
            persona_id=persona_id,
...
def get_persona_avatar(
    ...
    try:
        ...
        raise OrbyteError(OrbyteErrorCode.NOT_FOUND, "Avatar not found")
