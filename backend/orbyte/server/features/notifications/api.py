...
from orbyte.db.notification import count_notifications
from orbyte.db.notification import dismiss_notification
from orbyte.db.notification import dismiss_user_notifications
from orbyte.db.notification import get_notification_by_id
...
from orbyte.server.features.build.utils import ensure_build_mode_intro_notification
from orbyte.server.features.notifications.models import NotificationResponse
from orbyte.server.features.notifications.models import NotificationSummary
from orbyte.server.features.notifications.models import PaginatedNotifications
...
from orbyte.server.features.release_notes.utils import (
...
def _ensure_license_expiry_notification(user: User, db_session: Session) -> None:
    ...
    try:
        fetch_ee_implementation_or_noop(
            "orbyte.utils.license_notifications",
