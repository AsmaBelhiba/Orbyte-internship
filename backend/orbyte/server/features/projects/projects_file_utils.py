...
from orbyte.configs.app_configs import MAX_EMBEDDED_IMAGES_PER_UPLOAD
...
from orbyte.file_processing.extract_file_text import count_docx_embedded_images
from orbyte.file_processing.extract_file_text import count_pdf_embedded_images
...
from orbyte.file_processing.password_validation import is_file_password_protected
...
def _skip_token_threshold(extension: str) -> bool:
    ...
    return extension.lower() in OrbyteFileExtensions.TABULAR_EXTENSIONS
