...
from orbyte.db.persona import get_personas_by_ids
from orbyte.db.projects import get_project_token_count
from orbyte.db.projects import upload_files_to_user_files_with_indexing
from orbyte.server.features.projects.models import CategorizedFilesSnapshot
from orbyte.server.features.projects.models import ChatSessionRequest
from orbyte.server.features.projects.models import TokenCountResponse
from orbyte.server.features.projects.models import UserFileSnapshot
from orbyte.server.features.projects.models import UserProjectSnapshot
...
def _trigger_user_file_project_sync(
    ...
    if DISABLE_VECTOR_DB and background_tasks is not None:
        from orbyte.background.task_utils import drain_project_sync_loop
...
def delete_user_file(
    ...
    if DISABLE_VECTOR_DB:
        from orbyte.background.task_utils import drain_delete_loop
