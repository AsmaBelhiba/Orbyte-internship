...
from orbyte.access.hierarchy_access import get_user_external_group_ids
...
from orbyte.db.document import get_accessible_documents_for_hierarchy_node_paginated
from orbyte.db.engine.sql_engine import get_session
from orbyte.db.enums import Permission
from orbyte.db.hierarchy import get_accessible_hierarchy_nodes_for_source
from orbyte.db.hierarchy import search_accessible_hierarchy_nodes
from orbyte.db.models import User
from orbyte.db.opensearch_migration import get_opensearch_retrieval_state
from orbyte.server.features.hierarchy.constants import DOCUMENT_PAGE_SIZE
from orbyte.server.features.hierarchy.constants import HIERARCHY_NODE_DOCUMENTS_PATH
from orbyte.server.features.hierarchy.constants import HIERARCHY_NODE_SEARCH_LIMIT
from orbyte.server.features.hierarchy.constants import HIERARCHY_NODES_LIST_PATH
from orbyte.server.features.hierarchy.constants import HIERARCHY_NODES_PREFIX
from orbyte.server.features.hierarchy.constants import HIERARCHY_NODES_SEARCH_PATH
from orbyte.server.features.hierarchy.models import DocumentPageCursor
from orbyte.server.features.hierarchy.models import DocumentSortDirection
from orbyte.server.features.hierarchy.models import DocumentSortField
from orbyte.server.features.hierarchy.models import DocumentSummary
from orbyte.server.features.hierarchy.models import HierarchyNodeDocumentsRequest
from orbyte.server.features.hierarchy.models import HierarchyNodeDocumentsResponse
from orbyte.server.features.hierarchy.models import HierarchyNodeSearchResponse
from orbyte.server.features.hierarchy.models import HierarchyNodeSearchSummary
from orbyte.server.features.hierarchy.models import HierarchyNodesResponse
from orbyte.server.features.hierarchy.models import HierarchyNodeSummary
...
def _require_opensearch(db_session: Session) -> None:
    if not ENABLE_OPENSEARCH_INDEXING_FOR_ORBYTE:
        raise HTTPException(
            status_code=403,
