...
from orbyte.db.skill import create_skill__no_commit
from orbyte.db.skill import delete_skill
from orbyte.db.skill import fetch_skill
from orbyte.db.skill import list_skills
from orbyte.db.skill import replace_skill_bundle
...
from orbyte.db.users import fetch_user_by_id
...
from orbyte.server.features.skill.models import SkillBundleInspectResponse
...
from orbyte.server.features.skill.response_helpers import skill_preview_response
from orbyte.server.features.skill.response_helpers import skill_response_for_user
from orbyte.server.features.skill.response_helpers import skills_list_response_for_user
from orbyte.skills.built_in import BUILT_IN_SKILLS
from orbyte.skills.bundle import build_single_file_bundle
from orbyte.skills.bundle import build_skill_md
from orbyte.skills.bundle import compute_bundle_sha256
from orbyte.skills.bundle import inspect_custom_bundle
...
from orbyte.skills.bundle import update_custom_bundle_files
from orbyte.skills.bundle import validate_and_normalize_custom_bundle
from orbyte.skills.content import read_custom_skill_bundle_bytes
from orbyte.skills.ingest import delete_bundle_blob
from orbyte.skills.ingest import ingested_skill_bundle
from orbyte.skills.ingest import save_skill_bundle_bytes
...
def inspect_custom_skill_bundle_upload(
    ...
    if not upload.filename:
        raise OrbyteError(OrbyteErrorCode.INVALID_INPUT, "upload is missing a filename")
...
def transfer_current_user_skill_ownership(
    ...
    if target is None:
        raise OrbyteError(OrbyteErrorCode.NOT_FOUND, "New owner not found.")
