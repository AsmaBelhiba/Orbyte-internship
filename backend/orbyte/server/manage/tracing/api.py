...
from orbyte.db.models import TracingProviderConfig
...
from orbyte.server.manage.tracing.models import TracingProviderView
...
from orbyte.tracing.validation import validate_tracing_credentials
...
def _reject_if_multi_tenant() -> None:
    if MULTI_TENANT:
        raise OrbyteError(
            OrbyteErrorCode.SINGLE_TENANT_ONLY,
