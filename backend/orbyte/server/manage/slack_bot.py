...
from orbyte.db.constants import SLACK_BOT_PERSONA_PREFIX
...
from orbyte.db.slack_bot import remove_slack_bot
from orbyte.db.slack_bot import update_slack_bot
from orbyte.db.slack_channel_config import create_slack_channel_persona
from orbyte.db.slack_channel_config import fetch_slack_channel_config
from orbyte.db.slack_channel_config import fetch_slack_channel_configs
from orbyte.db.slack_channel_config import insert_slack_channel_config
from orbyte.db.slack_channel_config import remove_slack_channel_config
from orbyte.db.slack_channel_config import update_slack_channel_config
from orbyte.orbytebot.slack.config import validate_channel_name
from orbyte.server.manage.models import SlackBot
from orbyte.server.manage.models import SlackBotCreationRequest
from orbyte.server.manage.models import SlackChannelConfig
from orbyte.server.manage.models import SlackChannelConfigCreationRequest
from orbyte.server.manage.validate_tokens import validate_app_token
from orbyte.server.manage.validate_tokens import validate_bot_token
from orbyte.server.manage.validate_tokens import validate_user_token
...
def _form_channel_config(
    ...
    if (
        ...
        raise ValueError(
            "Cannot set OrbyteBot to respond to users in a private (ephemeral) message "
...
def create_bot(
    ...
    mt_cloud_telemetry(
        ...
        event=MilestoneRecordType.CREATED_ORBYTE_BOT,
    )
