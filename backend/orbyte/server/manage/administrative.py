...
from orbyte.configs.app_configs import GENERATIVE_MODEL_ACCESS_CHECK_FREQ
from orbyte.configs.constants import DocumentSource
from orbyte.configs.constants import KV_GEN_AI_KEY_CHECK_TIME
...
from orbyte.db.feedback import fetch_docs_ranked_by_boost_for_user
from orbyte.db.feedback import update_document_boost_for_user
from orbyte.db.feedback import update_document_hidden_for_user
from orbyte.db.index_attempt import cancel_indexing_attempts_for_ccpair
from orbyte.db.index_attempt import get_index_attempt_errors_across_connectors
...
from orbyte.server.manage.models import BoostDoc
from orbyte.server.manage.models import BoostUpdateRequest
from orbyte.server.manage.models import HiddenUpdateRequest
...
def create_deletion_attempt_for_connector_id(
    ...
    client_app.send_task(
        OrbyteCeleryTask.CHECK_FOR_CONNECTOR_DELETION,
