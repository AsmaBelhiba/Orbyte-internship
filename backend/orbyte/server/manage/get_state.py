...
from orbyte.auth.users import user_needs_to_be_verified
from orbyte.configs.app_configs import AUTH_TYPE
from orbyte.configs.constants import AuthType
from orbyte.configs.constants import DEV_VERSION_PATTERN
from orbyte.configs.constants import PUBLIC_API_TAGS
from orbyte.configs.constants import STABLE_VERSION_PATTERN
from orbyte.db.auth import get_user_count
from orbyte.server.manage.models import AllVersions
from orbyte.server.manage.models import AuthTypeResponse
from orbyte.server.manage.models import ContainerVersions
from orbyte.server.manage.models import SSOProviderOption
from orbyte.server.manage.models import VersionResponse
...
def get_versions() -> AllVersions:
    """
    Fetches the latest stable and beta versions of Orbyte Docker images.
    ...
    """
    # Fetch the latest tags from DockerHub for each Orbyte component
    dockerhub_repos = [
