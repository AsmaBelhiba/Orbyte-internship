...
from orbyte.llm.constants import DYNAMIC_LLM_PROVIDERS
...
from orbyte.server.manage.llm.utils import extract_vendor_from_model_name
from orbyte.server.manage.llm.utils import filter_model_configurations
...
if TYPE_CHECKING:
    ...
    from orbyte.db.models import ModelConfiguration as ModelConfigurationModel
...
class ModelConfigurationView(BaseModel):
    ...
    def from_model(
        ...
        from orbyte.llm.model_name_parser import parse_litellm_model_name
