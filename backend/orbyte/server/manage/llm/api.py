...
from orbyte.db.llm import fetch_default_vision_model
from orbyte.db.llm import fetch_existing_llm_provider_by_id
from orbyte.db.llm import fetch_existing_llm_providers
from orbyte.db.llm import fetch_existing_models
from orbyte.db.llm import fetch_model_configuration_by_id
from orbyte.db.llm import fetch_persona_with_groups
from orbyte.db.llm import fetch_user_group_ids
from orbyte.db.llm import remove_llm_provider
from orbyte.db.llm import sync_model_configurations
from orbyte.db.llm import update_default_provider
from orbyte.db.llm import update_default_vision_provider
from orbyte.db.llm import upsert_llm_provider
from orbyte.db.llm import validate_persona_ids_exist
from orbyte.db.models import Persona
from orbyte.db.models import User
from orbyte.db.persona import user_can_access_persona
...
from orbyte.llm.constants import PROVIDER_DISPLAY_NAMES
from orbyte.llm.constants import WELL_KNOWN_PROVIDER_NAMES
from orbyte.llm.factory import get_default_llm
from orbyte.llm.factory import get_llm
from orbyte.llm.factory import get_max_input_tokens_from_llm_provider
from orbyte.llm.model_capabilities import get_bedrock_token_limit
from orbyte.llm.model_capabilities import litellm_thinks_model_supports_image_input
from orbyte.llm.model_capabilities import model_is_reasoning_model
from orbyte.llm.utils import get_llm_contextual_cost
from orbyte.llm.utils import is_sensitive_custom_config_key
from orbyte.llm.utils import test_llm
from orbyte.llm.well_known_providers.auto_update_service import (
...
from orbyte.llm.well_known_providers.constants import VERTEX_AUTH_METHOD_SERVICE_ACCOUNT
...
from orbyte.llm.well_known_providers.constants import VERTEX_PROJECT_KWARG
from orbyte.llm.well_known_providers.llm_provider_options import (
    fetch_available_well_known_llms,
)
from orbyte.llm.well_known_providers.llm_provider_options import (
    WellKnownLLMProviderDescriptor,
)
from orbyte.server.manage.llm.models import BedrockFinalModelResponse
from orbyte.server.manage.llm.models import BedrockModelsRequest
from orbyte.server.manage.llm.models import BifrostFinalModelResponse
from orbyte.server.manage.llm.models import BifrostModelsRequest
from orbyte.server.manage.llm.models import CustomProviderOption
from orbyte.server.manage.llm.models import DefaultModel
from orbyte.server.manage.llm.models import LitellmFinalModelResponse
from orbyte.server.manage.llm.models import LitellmModelDetails
from orbyte.server.manage.llm.models import LitellmModelsRequest
from orbyte.server.manage.llm.models import LLMCost
from orbyte.server.manage.llm.models import LLMProviderDescriptor
from orbyte.server.manage.llm.models import LLMProviderResponse
...
from orbyte.server.manage.llm.models import LMStudioFinalModelResponse
from orbyte.server.manage.llm.models import LMStudioModelsRequest
from orbyte.server.manage.llm.models import ModelConfigurationUpsertRequest
from orbyte.server.manage.llm.models import NebiusTokenfactoryFinalModelResponse
from orbyte.server.manage.llm.models import NebiusTokenfactoryModelsRequest
from orbyte.server.manage.llm.models import OllamaFinalModelResponse
from orbyte.server.manage.llm.models import OllamaModelDetails
from orbyte.server.manage.llm.models import OllamaModelsRequest
from orbyte.server.manage.llm.models import OpenAICompatibleFinalModelResponse
from orbyte.server.manage.llm.models import OpenAICompatibleModelsRequest
from orbyte.server.manage.llm.models import OpenRouterFinalModelResponse
from orbyte.server.manage.llm.models import OpenRouterModelDetails
from orbyte.server.manage.llm.models import OpenRouterModelsRequest
from orbyte.server.manage.llm.models import SyncModelEntry
from orbyte.server.manage.llm.models import TestLLMRequest
from orbyte.server.manage.llm.models import VisionProviderResponse
from orbyte.server.manage.llm.provider_cache import cache_provider_listing
from orbyte.server.manage.llm.provider_cache import get_cached_provider_listing
from orbyte.server.manage.llm.provider_cache import invalidate_provider_listing_cache
from orbyte.server.manage.llm.utils import generate_bedrock_display_name
from orbyte.server.manage.llm.utils import generate_ollama_display_name
from orbyte.server.manage.llm.utils import is_embedding_model
from orbyte.server.manage.llm.utils import is_reasoning_model
from orbyte.server.manage.llm.utils import is_valid_bedrock_model
from orbyte.server.manage.llm.utils import ModelMetadata
from orbyte.server.manage.llm.utils import strip_openrouter_vendor_prefix
...
from orbyte.utils.encryption import mask_string as mask_with_ellipsis
...
def _validate_llm_provider_change(
    ...
    Raises:
        OrbyteError: If api_base or custom_config changed without changing API key
    """
...
def fetch_llm_provider_options(
    ...
    raise OrbyteError(OrbyteErrorCode.NOT_FOUND, f"Provider {provider_name} not found")
...
def test_default_provider(
    ...
    try:
        ...
        raise OrbyteError(OrbyteErrorCode.VALIDATION_ERROR, "No LLM Provider setup")

    error = test_llm(llm)
    if error:
        raise OrbyteError(OrbyteErrorCode.VALIDATION_ERROR, str(error))
...
def put_llm_provider(
    ...
    if existing_provider and is_creation:
        raise OrbyteError(
            OrbyteErrorCode.DUPLICATE_RESOURCE,
    ...
    try:
        ...
        if transitioning_to_auto_mode:
            from orbyte.db.llm import sync_auto_mode_models
        ...
        raise OrbyteError(OrbyteErrorCode.VALIDATION_ERROR, str(e))
    finally:
...
def delete_llm_provider(
    ...
    try:
        ...
        raise OrbyteError(OrbyteErrorCode.NOT_FOUND, str(e))
...
def list_llm_providers_for_persona(
    ...
    persona = fetch_persona_with_groups(db_session, persona_id)
    if not persona:
        raise OrbyteError(OrbyteErrorCode.PERSONA_NOT_FOUND, "Persona not found")
...
def get_bedrock_available_models(
    ...
    try:
        ...
        try:
            ...
            raise OrbyteError(
                OrbyteErrorCode.CREDENTIAL_INVALID,
...
def _get_ollama_available_model_names(api_base: str) -> set[str]:
    ...
    URL, so a server Orbyte can't route to is a client misconfiguration.
    """
    ...
    try:
        ...
        raise OrbyteError(
            ...
            f"is correct and reachable from Orbyte ({type(e).__name__}).",
        )
    except Exception as e:
        raise OrbyteError(
            OrbyteErrorCode.BAD_GATEWAY,
...
def _get_openai_compatible_models_response(
    ...
    try:
        ...
        raise OrbyteError(
            ...
            f"correct and reachable from Orbyte ({type(e).__name__}).",
        )
    except ValueError as e:
        logger.warning(
