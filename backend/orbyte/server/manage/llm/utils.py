...
from orbyte.llm.constants import BEDROCK_MODEL_NAME_MAPPINGS
from orbyte.llm.constants import LlmProviderNames
from orbyte.llm.constants import MODEL_PREFIX_TO_VENDOR
from orbyte.llm.constants import OLLAMA_MODEL_NAME_MAPPINGS
from orbyte.llm.constants import OLLAMA_MODEL_TO_VENDOR
...
def is_reasoning_model(model_id: str, display_name: str) -> bool:
    ...
    TODO: unify with model_is_reasoning_model (orbyte/llm/model_capabilities.py)
...
def filter_model_configurations(
    ...
    from orbyte.llm.well_known_providers.llm_provider_options import is_obsolete_model
