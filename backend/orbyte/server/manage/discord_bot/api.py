...
from orbyte.configs.app_configs import DISCORD_BOT_TOKEN
...
from orbyte.db.discord_bot import get_channel_config_by_internal_ids
...
from orbyte.server.manage.discord_bot.models import DiscordBotConfigCreateRequest
from orbyte.server.manage.discord_bot.models import DiscordBotConfigResponse
from orbyte.server.manage.discord_bot.models import DiscordChannelConfigResponse
from orbyte.server.manage.discord_bot.models import DiscordChannelConfigUpdateRequest
from orbyte.server.manage.discord_bot.models import DiscordGuildConfigCreateResponse
from orbyte.server.manage.discord_bot.models import DiscordGuildConfigResponse
from orbyte.server.manage.discord_bot.models import DiscordGuildConfigUpdateRequest
...
def _check_bot_config_api_access() -> None:
    ...
    - On Cloud (managed by Orbyte)
    - When DISCORD_BOT_TOKEN env var is set (managed via env)
    """
    if AUTH_TYPE == AuthType.CLOUD:
        raise HTTPException(
            status_code=status.HTTP_403_FORBIDDEN,
            detail="Discord bot configuration is managed by Orbyte on Cloud.",
        )
...
def delete_service_api_key_endpoint(
    ...
    Discord bot to authenticate with the Orbyte API. The key is also automatically
    deleted when:
