...
from orbyte.db.llm import update_no_default_contextual_rag_provider
...
from orbyte.db.search_settings import delete_search_settings
from orbyte.db.search_settings import get_current_search_settings
from orbyte.db.search_settings import get_embedding_provider_from_provider_type
...
from orbyte.db.search_settings import update_search_settings_status
...
from orbyte.file_processing.unstructured import delete_unstructured_api_key
from orbyte.file_processing.unstructured import get_unstructured_api_key
from orbyte.file_processing.unstructured import update_unstructured_api_key
from orbyte.natural_language_processing.search_nlp_models import clean_model_name
from orbyte.server.manage.embedding.models import SearchSettingsDeleteRequest
from orbyte.server.manage.models import FullModelVersionResponse
from orbyte.server.models import IdReturn
...
def set_new_search_settings(
    ...
    if MULTI_TENANT and search_settings_new.enable_contextual_rag:
        raise HTTPException(
            ...
            detail="Contextual RAG disabled in Orbyte Cloud",
        )
