...
class OrbyteJSONEncoder(json.JSONEncoder):
...
def get_json_line(
    json_dict: dict[str, Any], encoder: type[json.JSONEncoder] = OrbyteJSONEncoder
) -> str:
    """
    ...
    Args:
        ...
        encoder: JSON encoder class to use, defaults to OrbyteJSONEncoder.
