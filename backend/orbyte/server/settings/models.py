...
from orbyte.configs.app_configs import DEFAULT_PRUNING_FREQ
...
class UserSettings(Settings):
    ...
    # Feature flag for Orbyte Craft (Build Mode) - used for server-side redirects
    orbyte_craft_enabled: bool = False
    ...
    orbyte_craft_available: bool = False
    ...
    # Application version, read from the ORBYTE_VERSION env var at startup.
