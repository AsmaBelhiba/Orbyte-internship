...
from orbyte.access.access import user_can_access_chat_file
from orbyte.auth.api_key import get_hashed_api_key_from_request
from orbyte.auth.pat import get_hashed_pat_from_request
...
from orbyte.chat.chat_processing_checker import get_processing_run_id
from orbyte.chat.chat_processing_checker import is_chat_session_processing
from orbyte.chat.chat_state import ChatStateContainer
from orbyte.chat.chat_utils import convert_chat_history_basic
from orbyte.chat.chat_utils import create_chat_history_chain
from orbyte.chat.chat_utils import create_chat_session_from_request
from orbyte.chat.chat_utils import extract_headers
from orbyte.chat.models import ChatFullResponse
from orbyte.chat.models import CreateChatSessionID
from orbyte.chat.process_message import gather_stream_full
from orbyte.chat.process_message import handle_multi_model_stream
from orbyte.chat.process_message import handle_stream_message_objects
from orbyte.chat.prompt_utils import get_default_base_system_prompt
from orbyte.chat.stop_signal_checker import set_fence
from orbyte.chat.stream_buffer import has_stream_buffer
from orbyte.chat.stream_buffer import read_stream_chunks
from orbyte.configs.app_configs import WEB_DOMAIN
from orbyte.configs.chat_configs import CHAT_HEARTBEAT_INTERVAL_S
from orbyte.configs.chat_configs import CHAT_RESUME_POLL_INTERVAL_S
from orbyte.configs.chat_configs import HARD_DELETE_CHATS
...
from orbyte.configs.model_configs import LITELLM_PASS_THROUGH_HEADERS
from orbyte.db.chat import add_chats_to_session_from_slack_thread
from orbyte.db.chat import delete_all_chat_sessions_for_user
from orbyte.db.chat import delete_chat_session
from orbyte.db.chat import duplicate_chat_session_for_user_from_slack
from orbyte.db.chat import get_chat_message
from orbyte.db.chat import get_chat_messages_by_session
from orbyte.db.chat import get_chat_session_by_id
from orbyte.db.chat import get_chat_sessions_by_user
from orbyte.db.chat import set_as_latest_chat_message
from orbyte.db.chat import set_preferred_response
from orbyte.db.chat import translate_db_message_to_chat_message_detail
from orbyte.db.chat import update_chat_session
from orbyte.db.chat_search import search_chat_sessions
...
from orbyte.db.feedback import create_chat_message_feedback
from orbyte.db.feedback import remove_chat_message_feedback
from orbyte.db.models import ChatSessionSharedStatus
...
from orbyte.db.user_file import get_file_id_by_user_file_id
...
from orbyte.llm.factory import get_llm_token_counter
from orbyte.secondary_llm_flows.chat_session_naming import generate_chat_session_name
from orbyte.server.api_key_usage import check_api_key_usage
from orbyte.server.middleware.rate_limiting import get_feedback_rate_limiters
...
from orbyte.server.query_and_chat.models import ChatFeedbackRequest
from orbyte.server.query_and_chat.models import ChatMessageIdentifier
from orbyte.server.query_and_chat.models import ChatRenameRequest
from orbyte.server.query_and_chat.models import ChatSearchResponse
from orbyte.server.query_and_chat.models import ChatSessionCreationRequest
from orbyte.server.query_and_chat.models import ChatSessionDetailResponse
from orbyte.server.query_and_chat.models import ChatSessionDetails
from orbyte.server.query_and_chat.models import ChatSessionGroup
from orbyte.server.query_and_chat.models import ChatSessionsResponse
from orbyte.server.query_and_chat.models import ChatSessionSummary
from orbyte.server.query_and_chat.models import ChatSessionUpdateRequest
from orbyte.server.query_and_chat.models import CurrentRunInfo
from orbyte.server.query_and_chat.models import MessageOrigin
from orbyte.server.query_and_chat.models import RenameChatSessionResponse
from orbyte.server.query_and_chat.models import SendMessageRequest
from orbyte.server.query_and_chat.models import SetPreferredResponseRequest
from orbyte.server.query_and_chat.models import UpdateChatSessionTemperatureRequest
from orbyte.server.query_and_chat.models import UpdateChatSessionThreadRequest
from orbyte.server.query_and_chat.session_loading import (
    translate_assistant_message_to_packets,
)
from orbyte.server.query_and_chat.streaming_models import heartbeat_packet
from orbyte.server.query_and_chat.streaming_models import Packet
from orbyte.server.query_and_chat.token_limit import check_token_rate_limits
from orbyte.server.usage_limits import check_llm_cost_limit_for_provider
from orbyte.server.usage_limits import check_usage_and_raise
from orbyte.server.usage_limits import is_usage_limits_enabled
from orbyte.server.utils import get_json_line
from orbyte.tracing.framework.create import ensure_trace
from orbyte.utils.headers import get_custom_tool_additional_request_headers
...
def handle_send_chat_message(
    ...
    # Streaming path, normal Orbyte UI behavior
...
def fetch_chat_file(
    ...
    if not user_can_access_chat_file(file_id, user, db_session):
        ...
        raise OrbyteError(OrbyteErrorCode.NOT_FOUND, "File not found")
...
def resume_chat_stream(
    ...
    with get_session_with_current_tenant() as db_session:
        try:
            ...
            raise OrbyteError(OrbyteErrorCode.SESSION_NOT_FOUND)

    cache = get_cache_backend()
    run_id = get_processing_run_id(session_id, cache)
    if run_id is None or not has_stream_buffer(cache, session_id, run_id):
        raise OrbyteError(
            OrbyteErrorCode.NOT_FOUND, "No resumable run for this chat session"
        )
...
def stop_chat_session(
    ...
    try:
        ...
        raise OrbyteError(OrbyteErrorCode.SESSION_NOT_FOUND, "Chat session not found")
