...
from orbyte.db.targeted_reindex import count_targets_for_job
...
def submit_targeted_reindex(
    ...
    try:
        ...
        client_app.send_task(
            OrbyteCeleryTask.TARGETED_REINDEX_TASK,
            kwargs={
...
def get_targeted_reindex_status(
    ...
    if job is None:
        raise OrbyteError(OrbyteErrorCode.NOT_FOUND, "Job not found.")
