...
from orbyte.connectors.exceptions import ValidationError
from orbyte.connectors.factory import identify_connector_class
...
from orbyte.db.connector_credential_pair import get_connector_credential_pair_for_user
from orbyte.db.connector_credential_pair import (
    get_connector_credential_pair_from_id_for_user,
)
from orbyte.db.connector_credential_pair import remove_credential_from_connector
...
from orbyte.db.document import get_document_counts_for_cc_pairs
from orbyte.db.document import get_documents_for_cc_pair
...
from orbyte.db.index_attempt import count_index_attempt_errors_for_cc_pair
from orbyte.db.index_attempt import count_index_attempts_for_cc_pair
from orbyte.db.index_attempt import get_error_counts_for_index_attempts
...
from orbyte.redis.redis_connector_utils import get_deletion_attempt_snapshot
...
from orbyte.server.documents.models import CCPairSyncAttemptsResponse
from orbyte.server.documents.models import CCPropertyUpdateRequest
from orbyte.server.documents.models import CCStatusUpdateRequest
from orbyte.server.documents.models import ConnectorCredentialPairIdentifier
from orbyte.server.documents.models import ConnectorCredentialPairMetadata
from orbyte.server.documents.models import DocPermissionSyncAttemptSnapshot
from orbyte.server.documents.models import DocumentSyncStatus
from orbyte.server.documents.models import ExternalGroupSyncAttemptSnapshot
...
from orbyte.server.documents.models import IndexAttemptStageMetricsResponse
...
def get_index_attempt_stage_metrics(
    ...
    if index_attempt is None:
        raise OrbyteError(OrbyteErrorCode.NOT_FOUND, "Index attempt not found")
...
def _get_cc_pair_source_or_raise(
    ...
    Raises ``OrbyteError(NOT_FOUND)`` if the cc-pair doesn't exist or the user
...
def get_cc_pair_permission_sync_attempts(
    ...
    source_requires_doc_sync = fetch_ee_implementation_or_noop(
        "orbyte.external_permissions.sync_params",
