...
from orbyte.configs.constants import OrbyteCallTypes
from orbyte.configs.kg_configs import KG_METADATA_TRACKING_THRESHOLD
from orbyte.db.engine.sql_engine import get_session_with_current_tenant
from orbyte.db.entities import get_kg_entity_by_document
from orbyte.db.entity_type import get_entity_types
from orbyte.db.kg_config import KGConfigSettings
...
from orbyte.db.tag import get_structured_tags_for_document
from orbyte.kg.models import KGAttributeEntityOption
from orbyte.kg.models import KGAttributeTrackInfo
from orbyte.kg.models import KGAttributeTrackType
from orbyte.kg.models import KGChunkFormat
from orbyte.kg.models import KGClassificationInstructions
from orbyte.kg.models import KGClassificationResult
from orbyte.kg.models import KGDocumentDeepExtractionResults
from orbyte.kg.models import KGEnhancedDocumentMetadata
from orbyte.kg.models import KGImpliedExtractionResults
from orbyte.kg.models import KGMetadataContent
from orbyte.kg.utils.formatting_utils import extract_email
from orbyte.kg.utils.formatting_utils import get_entity_type
from orbyte.kg.utils.formatting_utils import kg_email_processing
from orbyte.kg.utils.formatting_utils import make_entity_id
from orbyte.kg.utils.formatting_utils import make_relationship_id
from orbyte.kg.utils.formatting_utils import make_relationship_type_id
from orbyte.kg.vespa.vespa_interactions import get_document_vespa_contents
...
from orbyte.prompts.kg_prompts import CALL_CHUNK_PREPROCESSING_PROMPT
from orbyte.prompts.kg_prompts import CALL_DOCUMENT_CLASSIFICATION_PROMPT
from orbyte.prompts.kg_prompts import GENERAL_CHUNK_PREPROCESSING_PROMPT
from orbyte.prompts.kg_prompts import MASTER_EXTRACTION_PROMPT
...
def kg_implied_extraction(
    ...
    document_is_from_call = document_entity_type.lower() in (
        call_type.value.lower() for call_type in OrbyteCallTypes
    )
...
def kg_classify_document(
    ...
    if entity_type not in (call_type.value for call_type in OrbyteCallTypes):
        return None
...
def kg_deep_extract_chunks(
    ...
    entity_type = get_entity_type(document_entity)
    is_call = entity_type in (call_type.value for call_type in OrbyteCallTypes)
