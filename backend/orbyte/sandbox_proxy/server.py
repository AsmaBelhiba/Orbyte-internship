...
from orbyte.sandbox_proxy.backend import build_ca_store
from orbyte.sandbox_proxy.backend import build_ip_lookup
from orbyte.sandbox_proxy.ca import CABootstrap
from orbyte.sandbox_proxy.ca import MaterializedCA
...
from orbyte.server.features.build.configs import SANDBOX_PROXY_HEALTHZ_PORT
from orbyte.server.features.build.configs import SANDBOX_PROXY_LISTEN_PORT
...
def build_resolvers() -> list[CredentialResolver]:
    ...
    """
    return [OrbytePatResolver(), LLMProviderKeyResolver(), ExternalAppResolver()]
