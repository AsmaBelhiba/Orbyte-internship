...
from orbyte.server.features.build.sandbox.kubernetes.k8s_client import build_core_v1_api
...
_SANDBOX_POD_SELECTOR = ",".join(
    [
        ...
        f"{LABEL_K8S_MANAGED_BY}={LABEL_K8S_MANAGED_BY_ORBYTE}",
    ]
)
...
def _identity_from_pod(pod: client.V1Pod) -> SandboxIdentity | None:
    ...
    if labels.get(LABEL_K8S_MANAGED_BY) != LABEL_K8S_MANAGED_BY_ORBYTE:
        return None
