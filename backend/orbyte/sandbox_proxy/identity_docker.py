...
from orbyte.server.features.build.sandbox.labels import LABEL_DOCKER_COMPONENT
from orbyte.server.features.build.sandbox.labels import LABEL_DOCKER_COMPONENT_SANDBOX
