...
from orbyte.document_index.disabled import DisabledDocumentIndex
...
def get_default_document_index(
    ...
    if ORBYTE_DISABLE_VESPA and not opensearch_retrieval_enabled:
        raise ValueError(
            "Bug: ORBYTE_DISABLE_VESPA is set but opensearch_retrieval_enabled is not set."
        )
...
def get_all_document_indices(
    ...
    if ORBYTE_DISABLE_VESPA and not ENABLE_OPENSEARCH_INDEXING_FOR_ORBYTE:
        raise ValueError(
            "Bug: ORBYTE_DISABLE_VESPA is set but ENABLE_OPENSEARCH_INDEXING_FOR_ORBYTE is not set."
        )
