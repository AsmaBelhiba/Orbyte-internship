...
from orbyte.configs.app_configs import DEFAULT_OPENSEARCH_QUERY_TIMEOUT_S
from orbyte.configs.app_configs import OPENSEARCH_EXPLAIN_ENABLED
from orbyte.configs.app_configs import OPENSEARCH_MATCH_HIGHLIGHTS_DISABLED
from orbyte.configs.app_configs import OPENSEARCH_PROFILING_DISABLED
from orbyte.configs.constants import DocumentSource
from orbyte.configs.constants import INDEX_SEPARATOR
...
from orbyte.document_index.opensearch.constants import ASSUMED_DOCUMENT_AGE_DAYS
from orbyte.document_index.opensearch.constants import (
...
from orbyte.document_index.opensearch.schema import CREATED_AT_FIELD_NAME
...
from orbyte.document_index.opensearch.schema import HIDDEN_FIELD_NAME
from orbyte.document_index.opensearch.schema import LAST_UPDATED_FIELD_NAME
from orbyte.document_index.opensearch.schema import MAX_CHUNK_SIZE_FIELD_NAME
from orbyte.document_index.opensearch.schema import METADATA_LIST_FIELD_NAME
from orbyte.document_index.opensearch.schema import PERSONAS_FIELD_NAME
from orbyte.document_index.opensearch.schema import PUBLIC_FIELD_NAME
from orbyte.document_index.opensearch.schema import SOURCE_TYPE_FIELD_NAME
from orbyte.document_index.opensearch.schema import TENANT_ID_FIELD_NAME
from orbyte.document_index.opensearch.schema import TITLE_FIELD_NAME
from orbyte.document_index.opensearch.schema import TITLE_VECTOR_FIELD_NAME
from orbyte.document_index.opensearch.schema import USER_PROJECTS_FIELD_NAME
...
class DocumentQuery:
    ...
    def get_from_document_id_query(
        ...
        Args:
            document_id: Orbyte document ID. Notably not an OpenSearch document
                ID, which points to what Orbyte would refer to as a chunk.
