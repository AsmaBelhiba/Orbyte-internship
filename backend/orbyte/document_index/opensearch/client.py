...
from orbyte.configs.app_configs import DEFAULT_OPENSEARCH_CLIENT_TIMEOUT_S
from orbyte.configs.app_configs import OPENSEARCH_ADMIN_PASSWORD
from orbyte.configs.app_configs import OPENSEARCH_ADMIN_USERNAME
from orbyte.configs.app_configs import OPENSEARCH_AUTH_METHOD
from orbyte.configs.app_configs import OPENSEARCH_AWS_REGION
from orbyte.configs.app_configs import OPENSEARCH_AWS_SERVICE
from orbyte.configs.app_configs import OPENSEARCH_CA_CERTS
from orbyte.configs.app_configs import OPENSEARCH_CLIENT_CERT
from orbyte.configs.app_configs import OPENSEARCH_CLIENT_KEY
from orbyte.configs.app_configs import OPENSEARCH_HOST
from orbyte.configs.app_configs import OPENSEARCH_REST_API_PORT
from orbyte.configs.app_configs import OPENSEARCH_USE_SSL
from orbyte.configs.app_configs import OPENSEARCH_VERIFY_CERTS
from orbyte.configs.app_configs import PIT_KEEP_ALIVE
...
from orbyte.document_index.opensearch.search import DEFAULT_OPENSEARCH_MAX_RESULT_WINDOW
...
class OpenSearchIndexClient(OpenSearchClient):
    ...
    most methods here return the minimum data needed for the rest of Orbyte, and
    ...
    def index_document(
        ...
        Args:
            document: The document to index. In Orbyte this is a chunk of a
    ...
    def bulk_index_documents(
        ...
        Args:
            documents: The documents to index. In Orbyte this is a chunk of a
                document, OpenSearch simply refers to this as a document as
                well.
            tenant_state: The tenant state of the caller.
            update_if_exists: Whether to update the document if it already
