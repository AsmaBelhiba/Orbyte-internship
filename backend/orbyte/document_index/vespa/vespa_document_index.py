...
from orbyte.configs.app_configs import RECENCY_BIAS_MULTIPLIER
from orbyte.configs.app_configs import RERANK_COUNT
from orbyte.configs.chat_configs import DOC_TIME_DECAY
from orbyte.configs.chat_configs import HYBRID_ALPHA
from orbyte.configs.chat_configs import TITLE_CONTENT_RATIO
from orbyte.configs.chat_configs import VESPA_SEARCHER_THREADS
from orbyte.configs.constants import KV_REINDEX_KEY
...
from orbyte.document_index.chunk_content_enrichment import cleanup_content_for_chunks
from orbyte.document_index.document_index_utils import get_document_chunk_ids
from orbyte.document_index.document_index_utils import get_uuid_from_chunk_info
...
from orbyte.document_index.vespa.chunk_retrieval import batch_search_api_retrieval
from orbyte.document_index.vespa.chunk_retrieval import get_all_chunks_paginated
from orbyte.document_index.vespa.chunk_retrieval import get_chunks_via_visit_api
from orbyte.document_index.vespa.chunk_retrieval import parallel_visit_api_retrieval
from orbyte.document_index.vespa.chunk_retrieval import query_vespa
from orbyte.document_index.vespa.deletion import delete_vespa_chunks
from orbyte.document_index.vespa.indexing_utils import BaseHTTPXClientContext
from orbyte.document_index.vespa.indexing_utils import batch_index_vespa_chunks
from orbyte.document_index.vespa.indexing_utils import check_for_final_chunk_existence
from orbyte.document_index.vespa.indexing_utils import clean_chunk_id_copy
from orbyte.document_index.vespa.indexing_utils import GlobalHTTPXClientContext
from orbyte.document_index.vespa.indexing_utils import TemporaryHTTPXClientContext
from orbyte.document_index.vespa.internal_types import EnrichedDocumentIndexingInfo
from orbyte.document_index.vespa.internal_types import MinimalDocumentIndexingInfo
from orbyte.document_index.vespa.internal_types import VespaChunkRequest
from orbyte.document_index.vespa.shared_utils.utils import get_vespa_http_client
from orbyte.document_index.vespa.shared_utils.utils import (
    replace_invalid_doc_id_characters,
)
from orbyte.document_index.vespa.shared_utils.vespa_request_builders import (
    build_vespa_filters,
)
from orbyte.document_index.vespa_constants import BATCH_SIZE
from orbyte.document_index.vespa_constants import CHUNK_ID
from orbyte.document_index.vespa_constants import CONTENT_SUMMARY
from orbyte.document_index.vespa_constants import DOCUMENT_ID
from orbyte.document_index.vespa_constants import DOCUMENT_ID_ENDPOINT
from orbyte.document_index.vespa_constants import NUM_THREADS
from orbyte.document_index.vespa_constants import SEARCH_ENDPOINT
from orbyte.document_index.vespa_constants import VESPA_APPLICATION_ENDPOINT
from orbyte.document_index.vespa_constants import VESPA_TIMEOUT
from orbyte.document_index.vespa_constants import YQL_BASE
...
def deploy_vespa_schemas(
    ...
    vespa_schema_path = os.path.join(
        os.getcwd(), "orbyte", "document_index", "vespa", "app_config"
    )
...
def register_multitenant_vespa_indices(
    ...
    if response.status_code != 200:
        raise RuntimeError(
            f"Failed to prepare Vespa Orbyte Indexes. Response: {response.text}"
        )
...
def _update_single_chunk(
    ...
    class _VespaPutFields(BaseModel):
        ...
        # backend/orbyte/document_index/vespa_constants.py.
