from orbyte.db.document import get_document_kg_entities_and_relationships
...
from orbyte.document_index.vespa.vespa_document_index import KGUChunkUpdateRequest
