...
from orbyte.context.search.retrieval.search_runner import search_chunks
...
from orbyte.natural_language_processing.english_stopwords import strip_stopwords
...
def search_pipeline(
    ...
    censored_chunks: list[InferenceChunk] = fetch_ee_implementation_or_noop(
        "orbyte.external_permissions.post_query_censoring",
