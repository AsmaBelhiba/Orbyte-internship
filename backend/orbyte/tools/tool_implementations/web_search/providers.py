...
from orbyte.tools.tool_implementations.open_url.firecrawl import FirecrawlClient
...
from orbyte.tools.tool_implementations.web_search.clients.searxng_client import (
    SearXNGClient,
)
from orbyte.tools.tool_implementations.web_search.clients.serper_client import (
    SerperClient,
)
from orbyte.tools.tool_implementations.web_search.clients.tavily_client import (
    TavilyClient,
)
from orbyte.tools.tool_implementations.web_search.models import DEFAULT_MAX_RESULTS
...
def build_content_provider_from_config(
    *,
    ...
    if provider_type == WebContentProviderType.ORBYTE_WEB_CRAWLER:
        if config.timeout_seconds is not None:
            return OrbyteWebCrawler(
