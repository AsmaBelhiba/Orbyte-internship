...
from orbyte.context.search.utils import inference_section_from_chunks
from orbyte.db.document import fetch_document_ids_by_links
from orbyte.db.document import filter_existing_document_ids
...
from orbyte.tools.models import OpenURLToolOverrideKwargs
...
from orbyte.tools.tool_implementations.web_search.utils import MAX_CHARS_PER_URL
...
from orbyte.utils.url import normalize_url as normalize_web_content_url
    ...
    def __init__(
        ...
        Args:
            ...
            content_provider: Optional content provider. If not provided,
                ...
                to the built-in Orbyte web crawler.
        """
        ...
        if content_provider is not None:
            ...
            if provider is None:
                raise RuntimeError(
                    ...
                    "built-in Orbyte web crawler can be initialized."
                )
