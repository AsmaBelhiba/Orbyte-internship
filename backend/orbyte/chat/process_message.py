...
from orbyte.chat.chat_processing_checker import set_processing_status
from orbyte.chat.chat_state import AvailableFiles
from orbyte.chat.chat_state import ChatStateContainer
from orbyte.chat.chat_state import ChatTurnSetup
from orbyte.chat.chat_utils import build_file_context
from orbyte.chat.chat_utils import convert_chat_history
...
from orbyte.chat.compression import get_compression_params
from orbyte.chat.emitter import Emitter
from orbyte.chat.llm_loop import EmptyLLMResponseError
from orbyte.chat.llm_loop import run_llm_loop
from orbyte.chat.models import AnswerStream
from orbyte.chat.models import AnswerStreamPart
from orbyte.chat.models import ChatBasicResponse
...
from orbyte.chat.models import ContextFileMetadata
from orbyte.chat.models import CreateChatSessionID
from orbyte.chat.models import ExtractedContextFiles
from orbyte.chat.models import FileToolMetadata
from orbyte.chat.models import SearchParams
from orbyte.chat.models import StreamingError
from orbyte.chat.models import ToolCallResponse
from orbyte.chat.prompt_utils import calculate_reserved_tokens
from orbyte.chat.save_chat import save_chat_turn
from orbyte.chat.stop_signal_checker import is_connected as check_stop_signal
from orbyte.chat.stop_signal_checker import reset_cancel_status
from orbyte.chat.stream_buffer import StreamBufferWriter
from orbyte.configs.app_configs import DISABLE_VECTOR_DB
from orbyte.configs.app_configs import INTEGRATION_TESTS_MODE
from orbyte.configs.chat_configs import CHAT_HEARTBEAT_INTERVAL_S
from orbyte.configs.constants import DEFAULT_PERSONA_ID
...
from orbyte.db.chat import reserve_message_id
from orbyte.db.chat import reserve_multi_model_message_ids
from orbyte.db.document_set import filter_document_set_names_by_user_access
...
from orbyte.db.projects import get_user_files_from_project
from orbyte.db.tools import get_tools
from orbyte.deep_research.dr_loop import run_deep_research_llm_loop
from orbyte.error_handling.error_codes import OrbyteErrorCode
from orbyte.error_handling.exceptions import log_orbyte_error
from orbyte.error_handling.exceptions import OrbyteError
from orbyte.file_processing.extract_file_text import extract_file_text
from orbyte.file_store.models import ChatFileType
from orbyte.file_store.models import InMemoryChatFile
from orbyte.file_store.utils import get_default_file_store
from orbyte.file_store.utils import load_in_memory_chat_files
from orbyte.file_store.utils import verify_user_files
from orbyte.hooks.executor import execute_hook
from orbyte.hooks.executor import HookSkipped
from orbyte.hooks.executor import HookSoftFailed
from orbyte.hooks.points.query_processing import QueryProcessingPayload
from orbyte.hooks.points.query_processing import QueryProcessingResponse
...
from orbyte.llm.request_context import reset_llm_mock_response
from orbyte.llm.request_context import set_llm_mock_response
from orbyte.llm.utils import litellm_exception_to_error_msg
from orbyte.orbytebot.slack.models import SlackContext
from orbyte.prompts.prompt_utils import substitute_user_placeholders
...
from orbyte.server.query_and_chat.models import ModelResponseSlot
from orbyte.server.query_and_chat.models import MultiModelMessageResponseIDInfo
...
from orbyte.tools.constants import FILE_READER_TOOL_ID
...
from orbyte.tools.tool_constructor import construct_tools
from orbyte.tools.tool_constructor import FileReaderToolConfig
from orbyte.tools.tool_constructor import SearchToolConfig
...
def _resolve_query_processing_hook_result(
    ...
    Returns the (possibly rewritten) message text, or raises OrbyteError with
    ...
    if not (hook_result.query and hook_result.query.strip()):
        raise OrbyteError(
            OrbyteErrorCode.QUERY_REJECTED,
...
def build_chat_turn(
    ...
    *,
    ...
    # Check LLM cost limits before using the LLM (only for Orbyte-managed keys),
...
def _stream_chat_turn(
    ...
    try:
        with get_session_with_current_tenant() as setup_db_session:
            try:
                if (
                    ...
                    # TODO @wenxi-orbyte: this check for doc set access has been added
        ...
        if e.error_code is not OrbyteErrorCode.QUERY_REJECTED:
            log_orbyte_error(e)
