...
from orbyte.db.user_file import calculate_user_files_token_count
from orbyte.file_store.models import FileDescriptor
from orbyte.prompts.chat_prompts import CITATION_REMINDER
from orbyte.prompts.chat_prompts import DEFAULT_SYSTEM_PROMPT
from orbyte.prompts.chat_prompts import FILE_REMINDER
from orbyte.prompts.chat_prompts import LAST_CYCLE_CITATION_REMINDER
from orbyte.prompts.chat_prompts import REQUIRE_CITATION_GUIDANCE
from orbyte.prompts.prompt_utils import get_company_context
from orbyte.prompts.prompt_utils import handle_orbyte_date_awareness
from orbyte.prompts.prompt_utils import replace_citation_guidance_tag
from orbyte.prompts.prompt_utils import replace_reminder_tag
from orbyte.prompts.tool_prompts import INTERNAL_SEARCH_GUIDANCE
from orbyte.prompts.tool_prompts import MEMORY_GUIDANCE
from orbyte.prompts.tool_prompts import OPEN_URLS_GUIDANCE
from orbyte.prompts.tool_prompts import TOOL_DESCRIPTION_SEARCH_GUIDANCE
from orbyte.prompts.tool_prompts import TOOL_SECTION_HEADER
from orbyte.prompts.tool_prompts import WEB_SEARCH_GUIDANCE
from orbyte.prompts.tool_prompts import WEB_SEARCH_SITE_DISABLED_GUIDANCE
from orbyte.prompts.user_info import BASIC_INFORMATION_PROMPT
from orbyte.prompts.user_info import ORGANIZATION_PROFILE_PROMPT
from orbyte.prompts.user_info import TEAM_INFORMATION_PROMPT
from orbyte.prompts.user_info import USER_INFORMATION_HEADER
from orbyte.prompts.user_info import USER_MEMORIES_PROMPT
from orbyte.prompts.user_info import USER_PREFERENCES_PROMPT
from orbyte.prompts.user_info import USER_ROLE_PROMPT
...
def build_system_prompt(
    ...
    """
    system_prompt = handle_orbyte_date_awareness(base_system_prompt, datetime_aware)
