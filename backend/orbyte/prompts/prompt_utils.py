...
from orbyte.auth.oauth_claims_capture import IDP_PLACEHOLDER_KEYS
from orbyte.configs.constants import DocumentSource
from orbyte.prompts.chat_prompts import ADDITIONAL_INFO
from orbyte.prompts.chat_prompts import CITATION_GUIDANCE_REPLACEMENT_PAT
from orbyte.prompts.chat_prompts import COMPANY_DESCRIPTION_BLOCK
from orbyte.prompts.chat_prompts import COMPANY_NAME_BLOCK
from orbyte.prompts.chat_prompts import DATETIME_REPLACEMENT_PAT
from orbyte.prompts.chat_prompts import REMINDER_TAG_REPLACEMENT_PAT
from orbyte.prompts.chat_prompts import REQUIRE_CITATION_GUIDANCE
from orbyte.prompts.constants import CODE_BLOCK_PAT
from orbyte.prompts.constants import REMINDER_TAG_DESCRIPTION
...
def handle_orbyte_date_awareness(
    prompt_str: str,
