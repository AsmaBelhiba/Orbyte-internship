...
from orbyte.db.federated import create_federated_connector_document_set_mapping
...
from orbyte.db.models import DocumentSet as DocumentSetDBModel
from orbyte.db.models import DocumentSet__ConnectorCredentialPair
from orbyte.db.models import DocumentSet__User
...
def delete_document_set_privacy__no_commit(
    ...
    """No private document sets in Orbyte MIT"""
...
def insert_document_set(
    ...
    try:
        ...
        versioned_private_doc_set_fn = fetch_versioned_implementation(
            "orbyte.db.document_set", "make_doc_set_private"
        )
...
def mark_document_set_as_to_be_deleted(
    ...
    try:
        ...
        versioned_delete_private_fn = fetch_versioned_implementation(
            "orbyte.db.document_set", "delete_document_set_privacy__no_commit"
        )
