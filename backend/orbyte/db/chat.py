...
from orbyte.context.search.models import SearchDoc as ServerSearchDoc
from orbyte.db.models import ChatMessage
from orbyte.db.models import ChatMessage__SearchDoc
...
from orbyte.db.persona import get_best_persona_id_for_user
...
# Chat sessions do not include orbytebot flows
def get_chat_sessions_by_user(
    user_id: UUID | None,
    deleted: bool | None,
    db_session: Session,
    include_orbytebot_flows: bool = False,
    limit: int = 50,
    ...
    if not include_orbytebot_flows:
        stmt = stmt.where(ChatSession.orbytebot_flow.is_(False))
...
def delete_all_chat_sessions_for_user(
    ...
    chat_sessions = (
        ...
        .filter(ChatSession.user_id == user_id, ChatSession.orbytebot_flow.is_(False))
        .all()
    )
...
def add_search_docs_to_tool_call(
    ...
    Args:
        ...
        db_session: The database session
    """
    from orbyte.db.models import ToolCall__SearchDoc
