...
from orbyte.configs.kg_configs import KG_SIMPLE_ANSWER_MAX_DISPLAYED_SOURCES
from orbyte.db.chunk import delete_chunk_stats_by_connector_credential_pair__no_commit
from orbyte.db.connector_credential_pair import get_connector_credential_pair_from_id
from orbyte.db.document_access import apply_document_access_filter
from orbyte.db.entities import delete_from_kg_entities__no_commit
from orbyte.db.entities import delete_from_kg_entities_extraction_staging__no_commit
from orbyte.db.enums import AccessType
from orbyte.db.enums import ConnectorCredentialPairStatus
from orbyte.db.feedback import delete_document_feedback_for_documents__no_commit
...
from orbyte.db.relationships import (
    delete_from_kg_relationships_extraction_staging__no_commit,
)
from orbyte.db.tag import delete_document_tags_for_documents__no_commit
from orbyte.db.utils import DocumentRow
from orbyte.db.utils import model_to_dict
...
def get_access_info_for_documents(
    ...
    - List of emails of Orbyte users with direct access to the doc (includes a "None" element if
