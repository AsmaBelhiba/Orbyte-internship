...
from orbyte.db.models import Hook
from orbyte.db.models import HookExecutionLog
...
def create_hook__no_commit(
    *,
    ...
    OrbyteError(CONFLICT) if a hook already exists, including under concurrent
