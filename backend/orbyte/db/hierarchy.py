...
def get_accessible_hierarchy_nodes_for_source(
    ...
    versioned_fn = fetch_versioned_implementation(
        "orbyte.db.hierarchy", "_get_accessible_hierarchy_nodes_for_source"
    )
...
def search_accessible_hierarchy_nodes(
    ...
    """
    versioned_fn = fetch_versioned_implementation(
        "orbyte.db.hierarchy", "_search_accessible_hierarchy_nodes"
    )
    return versioned_fn(
...
def filter_accessible_hierarchy_node_ids(
    ...
    if not node_ids:
        return set()
    versioned_fn = fetch_versioned_implementation(
        "orbyte.db.hierarchy", "_filter_accessible_hierarchy_node_ids"
    )
