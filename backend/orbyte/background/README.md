# Overview of Orbyte Background Jobs
...
Watchdog is a separate Python process managed by supervisord which runs alongside celery workers. It checks the ORBYTE_CELERY_BEAT_HEARTBEAT_KEY in
