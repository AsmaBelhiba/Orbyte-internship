...
from orbyte.access.access import source_should_fetch_permissions_during_indexing
from orbyte.background.indexing.checkpointing_utils import check_checkpoint_size
from orbyte.background.indexing.checkpointing_utils import get_latest_valid_checkpoint
from orbyte.background.indexing.checkpointing_utils import save_checkpoint
from orbyte.background.indexing.memory_tracer import MemoryTracer
from orbyte.configs.app_configs import INDEX_BATCH_SIZE
from orbyte.configs.app_configs import INDEXING_SIZE_WARNING_THRESHOLD
from orbyte.configs.app_configs import INDEXING_TRACER_INTERVAL
from orbyte.configs.app_configs import INTEGRATION_TESTS_MODE
from orbyte.configs.app_configs import LEAVE_CONNECTOR_ACTIVE_ON_INITIALIZATION_FAILURE
from orbyte.configs.app_configs import MAX_FILE_SIZE_BYTES
from orbyte.configs.app_configs import PERSISTENT_INDEXING
from orbyte.configs.app_configs import POLL_CONNECTOR_OFFSET
...
from orbyte.connectors.exceptions import UnexpectedValidationError
...
from orbyte.db.index_attempt import transition_attempt_to_in_progress
...
from orbyte.file_store.staging import RawFileCallback
...
from orbyte.utils.postgres_sanitization import sanitize_document_for_postgres
from orbyte.utils.postgres_sanitization import sanitize_hierarchy_nodes_for_postgres
...
def connector_document_extraction(
    ...
    with get_session_with_current_tenant() as db_session:
        ...
        docprocessing_priority = (
            OrbyteCeleryPriority.MEDIUM
            if has_successful_attempt
            else OrbyteCeleryPriority.HIGH
        )
        ...
        while checkpoint.has_more:
            ...
            for (
                ...
                with time_stage(IndexAttemptStage.DOC_BATCH_ENQUEUE, index_attempt_id):
                    ...
                    app.send_task(
                        OrbyteCeleryTask.DOCPROCESSING_TASK,
                        kwargs=processing_batch_data,
                        queue=OrbyteCeleryQueues.DOCPROCESSING,
