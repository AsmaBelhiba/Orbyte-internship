...
from orbyte.configs.constants import POSTGRES_CELERY_WORKER_MONITORING_APP_NAME
...
celery_app.config_from_object("orbyte.background.celery.configs.monitoring")
...
def _setup_prometheus_collectors(sender: Any) -> bool:
    ...
    """
    try:
        from orbyte.server.metrics.indexing_pipeline_setup import (
...
celery_app.autodiscover_tasks(
    app_base.filter_task_modules(
        [
            "orbyte.background.celery.tasks.monitoring",
        ]
    )
)
