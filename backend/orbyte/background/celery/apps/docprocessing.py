...
from orbyte.background.celery.tasks.docprocessing.batch_counters import (
    on_docprocessing_task_postrun,
)
from orbyte.background.celery.tasks.docprocessing.batch_counters import (
    on_docprocessing_task_prerun,
)
from orbyte.configs.constants import POSTGRES_CELERY_WORKER_DOCPROCESSING_APP_NAME
...
celery_app.config_from_object("orbyte.background.celery.configs.docprocessing")
