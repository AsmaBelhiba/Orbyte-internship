...
from orbyte.configs.app_configs import CELERY_BROKER_POOL_LIMIT
from orbyte.configs.app_configs import CELERY_RESULT_EXPIRES
from orbyte.configs.app_configs import REDIS_DB_NUMBER_CELERY
from orbyte.configs.app_configs import REDIS_DB_NUMBER_CELERY_RESULT_BACKEND
...
broker_transport_options = {
    "priority_steps": list(range(len(OrbyteCeleryPriority))),
...
task_default_priority = OrbyteCeleryPriority.MEDIUM
task_acks_late = True
