...
from orbyte.access.access import get_access_for_document
...
from orbyte.background.celery.tasks.shared.tasks import LIGHT_SOFT_TIME_LIMIT
from orbyte.background.celery.tasks.shared.tasks import LIGHT_TIME_LIMIT
...
from orbyte.configs.app_configs import VESPA_SYNC_MAX_TASKS
from orbyte.configs.constants import CELERY_VESPA_SYNC_BEAT_LOCK_TIMEOUT
...
from orbyte.db.document import get_document
...
from orbyte.db.document_set import delete_document_set
from orbyte.db.document_set import fetch_document_sets
from orbyte.db.document_set import fetch_document_sets_for_document
from orbyte.db.document_set import get_document_set_by_id
from orbyte.db.document_set import mark_document_set_as_synced
...
from orbyte.db.sync_record import cleanup_sync_records
...
from orbyte.redis.redis_document_set import RedisDocumentSet
...
from orbyte.redis.redis_usergroup import RedisUserGroup
...
from orbyte.utils.variable_functionality import noop_fallback
...
@shared_task(
    name=OrbyteCeleryTask.CHECK_FOR_VESPA_SYNC_TASK,
    ignore_result=True,
...
def check_for_vespa_sync_task(self: Task, *, tenant_id: str) -> bool | None:
    ...
    lock_beat: RedisLock = r.lock(
        OrbyteRedisLocks.CHECK_VESPA_SYNC_BEAT_LOCK,
        ...
        if global_version.is_ee_version():
            try:
                fetch_user_groups = fetch_versioned_implementation(
                    "orbyte.db.user_group", "fetch_user_groups"
                )
        ...
        for key in keys:
            ...
            if key_str == DOCUMENT_SYNC_FENCE_KEY:
                ...
                monitor_usergroup_taskset = (
                    fetch_versioned_implementation_with_fallback(
                        "orbyte.background.celery.tasks.vespa.tasks",
                        "monitor_usergroup_taskset",
                        noop_fallback,
                    )
                )
...
def try_generate_user_group_sync_tasks(
    ...
    fetch_user_group = cast(
        ...
        fetch_versioned_implementation("orbyte.db.user_group", "fetch_user_group"),
    )
...
@shared_task(
    name=OrbyteCeleryTask.DOCUMENT_INDEX_METADATA_SYNC_TASK,
    bind=True,
...
def document_index_metadata_sync_task(
    ...
    *,
    ...
    completion_status = OrbyteCeleryTaskCompletionStatus.UNDEFINED
    ...
    try:
        with get_session_with_current_tenant() as db_session:
            ...
            if not doc:
                ...
                completion_status = OrbyteCeleryTaskCompletionStatus.SKIPPED
            else:
                # document set sync
                ...
                completion_status = OrbyteCeleryTaskCompletionStatus.SUCCEEDED
    except SoftTimeLimitExceeded:
        task_logger.info(f"SoftTimeLimitExceeded exception. doc={document_id}")
        completion_status = OrbyteCeleryTaskCompletionStatus.SOFT_TIME_LIMIT
        ...
        while True:
            ...
            if isinstance(e, httpx.HTTPStatusError):
                ...
                completion_status = (
                    OrbyteCeleryTaskCompletionStatus.NON_RETRYABLE_EXCEPTION
                )
                break
            ...
            completion_status = OrbyteCeleryTaskCompletionStatus.RETRYABLE_EXCEPTION
            if (
    ...
    return completion_status == OrbyteCeleryTaskCompletionStatus.SUCCEEDED
