...
from orbyte.db.opensearch_migration import build_sanitized_to_original_doc_id_mapping
from orbyte.db.opensearch_migration import get_vespa_visit_state
from orbyte.db.opensearch_migration import is_migration_completed
from orbyte.db.opensearch_migration import (
    mark_migration_completed_time_if_not_set_with_commit,
)
from orbyte.db.opensearch_migration import (
    try_insert_opensearch_tenant_migration_record_with_commit,
)
from orbyte.db.opensearch_migration import update_vespa_visit_progress_with_commit
...
@shared_task(
    name=OrbyteCeleryTask.MIGRATE_CHUNKS_FROM_VESPA_TO_OPENSEARCH_TASK,
...
def migrate_chunks_from_vespa_to_opensearch_task(
    ...
    *,
    ...
    lock: RedisLock = r.lock(
        name=OrbyteRedisLocks.OPENSEARCH_MIGRATION_BEAT_LOCK,
