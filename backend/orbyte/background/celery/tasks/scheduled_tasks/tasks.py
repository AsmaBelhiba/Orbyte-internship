...
from orbyte.db.scheduled_task import advance_next_run_at
from orbyte.db.scheduled_task import claim_due_scheduled_tasks
from orbyte.db.scheduled_task import find_stuck_runs
from orbyte.db.scheduled_task import has_in_flight_run_for_task
...
@shared_task(
    name=OrbyteCeleryTask.SCHEDULED_TASKS_DISPATCH_DUE,
    ignore_result=True,
    bind=True,
)
...
@shared_task(
    name=OrbyteCeleryTask.SCHEDULED_TASKS_RUN,
    ignore_result=True,
...
@shared_task(
    name=OrbyteCeleryTask.SCHEDULED_TASKS_CLEANUP_STUCK,
    ignore_result=True,
    bind=True,
)
