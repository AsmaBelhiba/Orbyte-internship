...
from orbyte.configs.app_configs import IMAGE_SUMMARIZATION_SYSTEM_PROMPT
from orbyte.configs.app_configs import IMAGE_SUMMARIZATION_USER_PROMPT
from orbyte.llm.interfaces import LLM
from orbyte.llm.models import ChatCompletionMessage
from orbyte.llm.models import ContentPart
...
from orbyte.server.metrics.image_processing import track_image_summarization
