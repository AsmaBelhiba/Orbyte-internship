...
from orbyte.configs.app_configs import DISABLE_INDEX_UPDATE_ON_SWAP
...
from orbyte.configs.app_configs import VESPA_NUM_ATTEMPTS_ON_STARTUP
from orbyte.configs.constants import KV_REINDEX_KEY
from orbyte.configs.embedding_configs import SUPPORTED_EMBEDDING_MODELS
from orbyte.configs.embedding_configs import SupportedEmbeddingModel
from orbyte.configs.model_configs import GEN_AI_API_KEY
from orbyte.configs.model_configs import GEN_AI_MODEL_VERSION
from orbyte.context.search.models import SavedSearchSettings
from orbyte.db.connector import check_connectors_exist
from orbyte.db.connector import create_initial_default_connector
from orbyte.db.connector_credential_pair import associate_default_cc_pair
...
from orbyte.db.credentials import create_initial_public_credential
from orbyte.db.document import check_docs_exist
from orbyte.db.enums import EmbeddingPrecision
from orbyte.db.index_attempt import cancel_indexing_attempts_past_model
from orbyte.db.index_attempt import expire_index_attempts
...
from orbyte.db.search_settings import update_current_search_settings
...
from orbyte.document_index.opensearch.opensearch_document_index import set_cluster_state
from orbyte.document_index.vespa.vespa_document_index import (
...
from orbyte.llm.well_known_providers.llm_provider_options import get_openai_model_names
...
from orbyte.server.settings.store import store_settings
from orbyte.utils.gpu_utils import gpu_status_request
...
def setup_orbyte(
    ...
    """
    Setup Orbyte for a particular tenant. In the Single Tenant case, it will set it up for the default schema
...
def setup_multitenant_orbyte() -> None:
    if DISABLE_VECTOR_DB:
    ...
    if not MANAGED_VESPA and not ORBYTE_DISABLE_VESPA:
