...
from orbyte.configs.app_configs import PRUNE_FAILURE_BACKOFF_SECONDS
...
class RedisConnectorPrune:
    ...
    def get_active_task_count(self) -> int:
        ...
        for _ in self.redis.sscan_iter(
            OrbyteRedisConstants.ACTIVE_FENCES,
    ...
    def generate_tasks(
        ...
        for doc_id in documents_to_prune:
            ...
            result = celery_app.send_task(
                OrbyteCeleryTask.DOCUMENT_BY_CC_PAIR_CLEANUP_TASK,
                kwargs=dict(
                    document_id=doc_id,
                ...
                queue=OrbyteCeleryQueues.CONNECTOR_DELETION,
