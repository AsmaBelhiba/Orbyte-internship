...
from orbyte.configs.chat_configs import SKIP_DEEP_RESEARCH_CLARIFICATION
from orbyte.configs.constants import MessageType
from orbyte.db.engine.sql_engine import get_session_with_current_tenant
from orbyte.db.tools import get_tool_by_name
from orbyte.deep_research.dr_mock_tools import get_clarification_tool_definitions
from orbyte.deep_research.dr_mock_tools import get_orchestrator_tools
from orbyte.deep_research.dr_mock_tools import RESEARCH_AGENT_TOOL_NAME
...
from orbyte.prompts.deep_research.orchestration_layer import CLARIFICATION_PROMPT
from orbyte.prompts.deep_research.orchestration_layer import FINAL_REPORT_PROMPT
from orbyte.prompts.deep_research.orchestration_layer import FIRST_CYCLE_REMINDER
from orbyte.prompts.deep_research.orchestration_layer import FIRST_CYCLE_REMINDER_TOKENS
...
from orbyte.server.query_and_chat.streaming_models import DeepResearchPlanDelta
from orbyte.server.query_and_chat.streaming_models import DeepResearchPlanStart
...
from orbyte.tools.fake_tools.research_agent import run_research_agent_calls
...
def run_deep_research_llm_loop(
    ...
    with trace(
        ...
        from orbyte.llm.litellm_singleton.config import initialize_litellm
