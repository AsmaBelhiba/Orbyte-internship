...
const documentToSourceInfo = (doc: OrbyteDocument): SourceInfo => ({
  id: doc.document_id,
          ...
          <div className="flex flex-col">
            ...
            {displayDocuments ? (
              <SearchChipList
                ...
                getKey={(doc: OrbyteDocument) => doc.document_id}
                toSourceInfo={(doc: OrbyteDocument) => documentToSourceInfo(doc)}
