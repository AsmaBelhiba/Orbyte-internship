...
import { OrbyteLoader } from "@/refresh-components/OrbyteLoader";
...
/**
 * Full-page loading state: the animated Orbyte mark with a "Loading …" label,
 ...
 * loader without a label, use `OrbyteLoader` directly.
 */
