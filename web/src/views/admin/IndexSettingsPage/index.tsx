...
const CLOUD_TOOLTIP = "This setting is managed by Orbyte Cloud.";
                ...
                <>
                  ...
                  >
                    <Content
                      ...
                      description="Orbyte uses this model to encode documents for search and retrieval."
                      ...
                      <CloudDisabled>
                        <Card border="solid" rounding="lg" padding="sm">
                          <GeneralLayouts.Section padding={0.5}>
                            <Content
                              icon={SvgVector}
                              title="Embedding model and settings are managed by Orbyte Cloud."
                              sizePreset="main-ui"
                              variant="section"
                            />
                          </GeneralLayouts.Section>
