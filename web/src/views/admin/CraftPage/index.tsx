...
export default function CraftPage() {
  ...
  const header = (
    <SettingsLayouts.Header
      ...
      description="Control who can use Craft, Orbyte's agentic app builder."
      divider
    />
  );
      ...
      <SettingsLayouts.Root>
        ...
        <SettingsLayouts.Body>
          <IllustrationContent
            ...
            description="Craft is enabled per deployment by Orbyte. Contact your Orbyte representative to get access."
          />
        </SettingsLayouts.Body>
      </SettingsLayouts.Root>
    );
