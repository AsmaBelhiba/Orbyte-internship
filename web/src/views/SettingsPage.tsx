    ...
    <Section gap={2}>
      <Section gap={0.75}>
        ...
        <Card>
          <InputHorizontal
            title="Default Model"
            description="This model will be used by Orbyte by default in your chats."
            withLabel
          >
            <ModelSelector
              value={
      ...
      <Section gap={0.75}>
        ...
        <Card>
          <InputHorizontal
            ...
            description="Let Orbyte reference stored memories in chats."
            withLabel
          >
            <Switch
          ...
          <InputHorizontal
            ...
            description="Let Orbyte generate and update stored memories."
            withLabel
          >
            <Switch
    ...
    <>
      ...
      {tokenToDelete && (
        ...
        >
          <Section gap={0.5} alignItems="start">
            <Text color="text-05">
              {`Any application using the token ${tokenToDelete.name} (${tokenToDelete.token_display}) will lose access to Orbyte. This action cannot be undone.`}
            </Text>
            <Text color="text-05">
    ...
    <>
      {showDisconnectConfirmation && (
        ...
        >
          <Section gap={0.5} alignItems="start">
            <Text color="text-05">
              {`Orbyte will no longer be able to access or search content from your ${sourceMetadata.displayName} account.`}
            </Text>
            <Text color="text-05">
