    ...
    <>
      <InputPadder>
        <Section gap={1}>
          ...
          <InputVertical
            ...
            subDescription="Choose how Orbyte should authenticate with Bedrock."
          >
      ...
      {authMethod === AUTH_METHOD_IAM && (
        <InputPadder>
          <MessageCard
            variant="info"
            title="Orbyte will use the IAM role attached to the environment it’s running in to authenticate."
          />
        </InputPadder>
      )}
