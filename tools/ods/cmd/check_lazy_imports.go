...
import (
	...
	"github.com/orbyte-dot-app/orbyte/tools/ods/internal/lazyimports"
)
...
Examples:
  ...
  ods check-lazy-imports orbyte/llm/           # Check only files in orbyte/llm/
  ods check-lazy-imports orbyte/chat/chat.py   # Check a specific file`,
