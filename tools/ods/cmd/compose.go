...
func NewComposeCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "compose [profile]",
		Short: "Launch Orbyte docker containers",
		Long: `Launch Orbyte docker containers using docker compose.
...
// compose project by running "docker compose -p orbyte ps --services".
