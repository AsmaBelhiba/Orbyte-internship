"""Locust entrypoint for Orbyte chat load tests.
...
README "Worker concurrency sweep"). ORBYTE_SHAPE=stepramp drives a staged ramp.
...
from orbyte_client.chat_user import BasicChatUser
...
if os.environ.get("ORBYTE_SHAPE") == "stepramp":
