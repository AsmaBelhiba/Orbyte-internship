...
export const DEFAULT_ORBYTE_DOMAIN = "http://localhost:3000";

export const SIDE_PANEL_PATH = "/nrf/side-panel";

export const ACTIONS = {
  GET_SELECTED_TEXT: "getSelectedText",
  GET_CURRENT_ORBYTE_DOMAIN: "getCurrentOrbyteDomain",
  UPDATE_PAGE_URL: "updatePageUrl",
  SEND_TO_ORBYTE: "sendToOrbyte",
  ...
  OPEN_ORBYTE_WITH_INPUT: "openOrbyteWithInput",
...
export const CHROME_SPECIFIC_STORAGE_KEYS = {
  ORBYTE_DOMAIN: "orbyteExtensionDomain",
  USE_ORBYTE_AS_DEFAULT_NEW_TAB: "orbyteExtensionDefaultNewTab",
  THEME: "orbyteExtensionTheme",
  BACKGROUND_IMAGE: "orbyteExtensionBackgroundImage",
  DARK_BG_URL: "orbyteExtensionDarkBgUrl",
  LIGHT_BG_URL: "orbyteExtensionLightBgUrl",
  ONBOARDING_COMPLETE: "orbyteExtensionOnboardingComplete",
};
